...
export const defaultUrl = atom({
  ...
  // default: "http://192.168.3.111:7000",   // Usama Faheem Ahme
  ...
  default: "https://as.denarowealth.com.au", // Live domain link
  // default: "",
});
...
export const CashFlowLastSyncAt = atom({
  key: "CashFlowLastSyncAt",
  default: new Date(),
});
