...
// clientValidation
ClientNetBusinessIncome:Yup.string().when("ClientEdit", {
...
ClientIndexation:Yup.string().when("ClientEdit", {
  ...
  otherwise: Yup.string().notRequired(),
    ...
    // partnervalidation
    PartnerNetBusinessIncome:Yup.string().when("PartnerEdit", {
      is: (val) => val && val.length == 3,
      then: Yup.string().matches(/^(1|[1-9][0-9]*)$/, 'Must be a positive number').required('Required'),
      otherwise: Yup.string().matches(/^(1|[1-9][0-9]*)$/, 'Must be a positive number').notRequired(""),
    }),
...
//     }),
  ...
  let onSubmit=(values)=>{
    ...
    let clientObj={
      ClientNetBusinessIncome:values.ClientNetBusinessIncome,
    ...
    let partnerObj={
      PartnerNetBusinessIncome:values.PartnerNetBusinessIncome,
                              ...
                              {/* switch button style */}
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-md-3">
                                      <div className="mb-3">
                                        <label
                                          htmlFor="ClientNetBusinessIncome"
                                        ...
                                        <Field
                                          ...
                                          id="ClientNetBusinessIncome"
                                          name='ClientNetBusinessIncome'
                                          placeholder="Net Business Income"
                                          disabled={values.ClientEdit==="Yes"? false : true}
                                        />
                                        <ErrorMessage component='div' className="text-danger fw-bold" name='ClientNetBusinessIncome'/>
                                      </div>
                                    </div>
                              ...
                              {/* switch button style */}
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-md-3">
                                      <div className="mb-3">
                                        <label
                                          htmlFor="PartnerNetBusinessIncome"
                                          className="form-label"
                                        >
                                         Net Business Income
                                        </label>
                                        <Field
                                          type="number"
                                          className="form-control inputDesign  shadow"
                                          id="PartnerNetBusinessIncome"
                                          name='PartnerNetBusinessIncome'
                                          placeholder="Net Business Income"
                                          disabled={values.PartnerEdit==="Yes"? false : true}
                                        />
                                        <ErrorMessage component='div' className="text-danger fw-bold" name='PartnerNetBusinessIncome'/>
                                      </div>
                                    </div>
...
export default SoleTraderIncome
