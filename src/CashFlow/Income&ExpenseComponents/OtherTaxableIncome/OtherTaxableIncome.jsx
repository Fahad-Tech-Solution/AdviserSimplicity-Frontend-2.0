...
// clientValidation
ClientOthertaxableIncome:Yup.string().when("ClientEdit", {
...
ClientIndexation:Yup.string().when("ClientEdit", {
  ...
  otherwise: Yup.string().notRequired(),
    ...
    // partnervalidation
    PartnerOthertaxableIncome:Yup.string().when("PartnerEdit", {
      is: (val) => val && val.length == 3,
      then: Yup.string().matches(/^(1|[1-9][0-9]*)$/, 'Must be a positive number').required('Required'),
      otherwise: Yup.string().matches(/^(1|[1-9][0-9]*)$/, 'Must be a positive number').notRequired(""),
    }),
...
PartnerupUntilYear: Yup.string().when("PartnerEdit", {
  ...
  let onSubmit=(values)=>{
    ...
    let clientObj={
      ClientOthertaxableIncome:values.ClientOthertaxableIncome,
    ...
    let partnerObj={
      PartnerOthertaxableIncome:values.PartnerOthertaxableIncome,
                              ...
                              {/* switch button style */}
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-md-3">
                                      <div className="mb-3">
                                        <label
                                          htmlFor="ClientOthertaxableIncome"
                                        ...
                                        <Field
                                          ...
                                          id="ClientOthertaxableIncome"
                                          name='ClientOthertaxableIncome'
                                          placeholder="Other taxable Income"
                                          disabled={values.ClientEdit==="Yes"? false : true}
                                        />
                                        <ErrorMessage component='div' className="text-danger fw-bold" name='ClientOthertaxableIncome'/>
                                      </div>
                                    </div>
                              ...
                              {/* switch button style */}
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-md-3">
                                      <div className="mb-3">
                                        <label
                                          htmlFor="PartnerOthertaxableIncome"
                                          className="form-label"
                                        >
                                         Other taxable Income
                                        </label>
                                        <Field
                                          type="number"
                                          className="form-control inputDesign  shadow"
                                          id="PartnerOthertaxableIncome"
                                          name='PartnerOthertaxableIncome'
                                          placeholder="Other taxable Income"
                                          disabled={values.PartnerEdit==="Yes"? false : true}
                                        />
                                        <ErrorMessage component='div' className="text-danger fw-bold" name='PartnerOthertaxableIncome'/>
                                      </div>
                                    </div>
...
export default OtherTaxableIncome
