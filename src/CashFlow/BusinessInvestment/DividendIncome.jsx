...
const DividendIncome = (props) => {
    ...
    let onSubmit = (values) => {
        props.setFieldValue(props.modalObject.stakeHolder + props.modalObject.key, values.dividendIncome)
    ...
    const [rowConfig, setRowConfig] = useState(() => {
        ...
        if (props.modalObject.sourceObj.title === "Bucket Company") {
            ...
            OriginalArray = OriginalArray.filter(item => item.name !== "takeAsCashFromUntilYear");
