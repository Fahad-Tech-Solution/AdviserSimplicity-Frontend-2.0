...
const InvestmentPropertyLoanRepayments = () => {
  let [PropertyLoanRepaymentsModal, setPropertyLoanRepaymentsModal] = useState(false);
  let [PropertyLoanRepayments, setPropertyLoanRepayments] = useState([]);
...
        }),
  ...
  function onSubmit(values, { resetForm }) {
    ...
    setPropertyLoanRepayments([...PropertyLoanRepayments, data]);
    resetForm();
  }
    ...
    <>
      ...
      <br/>
        <button type="button" className="btn btn-outline-success"
          onClick={() => { setPropertyLoanRepaymentsModal(true); }}
        >
      ...
      <Modal
        show={PropertyLoanRepaymentsModal}
        onHide={() => { setPropertyLoanRepaymentsModal(false) }}
        backdrop="static"
        className="modal-xl"
        keyboard={false}
      >
                ...
                <div className="row">
                  ...
                  <div className="col-md-3">
                    ...
                    <Field as="select" className="form-select shadow inputDesign" id="InvestmentLoan"
                      ...
                      <option value="Investment Loan 1">Investment Loan 1</option>
                  ...
                  <div className="col-md-3">
                    ...
                    <Field type="number" className="form-control shadow inputDesign" id="Balance"
                  ...
                  <div className="col-md-12">
                    <div className="table-responsive my-3">
                      <table className="table table-bordered table-hover text-center">
                        ...
                        <tbody>
                          {PropertyLoanRepayments.map((elem, index) => {
                            return (
                              <tr>
              ...
              <Modal.Footer>
                <div className="col-md-12">
                  ...
                  <button
                    ...
                    onClick={() => { setPropertyLoanRepaymentsModal(false) }}
                  >
                    Cancel
                  </button>
                </div>
...
export default InvestmentPropertyLoanRepayments;
