...
const InvestmentsSharesManagedFunds = () => {
  ...
  let validationSchema = Yup.object({
    DirectOpeningValue: Yup.number().when('ClientEdit', {
    ...
    DirectCostBase: Yup.number().when('ClientEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    DirectRegularContributions: Yup.number().when('ClientEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    DirectContributeYear: Yup.string().when('ClientEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    DirectContributeUntil: Yup.string().when('ClientEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    Indexation: Yup.string().when('ClientEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    DirectReinvestUntil: Yup.string().when('ClientEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    DirectInvestmentReturns: Yup.string().when('ClientEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    ...
    DirectRiskProfile: Yup.string().when('ClientEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    DirectOngoingFees: Yup.number().when('ClientEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    ManagedOpeningValue: Yup.number().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    ManagedCostBase: Yup.number().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    ManagedRegularContributions: Yup.number().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    ManagedContributeYear: Yup.string().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    ManagedContributeUntil: Yup.string().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    ManagedIndexation: Yup.string().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    ManagedReinvestUntil: Yup.string().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    ManagedInvestmentReturns: Yup.string().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    ...
    ManagedRiskProfile: Yup.string().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    ManagedOngoingFees: Yup.number().when('PartnerEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    OtherOpeningValue: Yup.number().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    OtherCostBase: Yup.number().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    OtherRegularContributions: Yup.number().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    OtherContributeYear: Yup.string().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    OtherContributeUntil: Yup.string().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    OtherIndexation: Yup.string().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    OtherReinvestUntil: Yup.string().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    OtherInvestmentReturns: Yup.string().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    ...
    OtherRiskProfile: Yup.string().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required")
    }),
    OtherOngoingFees: Yup.number().when('JointEdit', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
