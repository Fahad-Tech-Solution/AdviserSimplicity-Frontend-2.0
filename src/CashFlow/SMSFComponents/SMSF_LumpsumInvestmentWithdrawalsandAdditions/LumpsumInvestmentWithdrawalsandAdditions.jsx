...
const LumpsumInvestmentWithdrawalsandAdditions = () => {
  let [LumpsumInvestmentWithdrawalsModal, setLumpsumInvestmentWithdrawalsModal] = useState(false);
  let [LumpsumInvestmentWithdrawals, setLumpsumInvestmentWithdrawals] = useState([]);
...
        }),
  ...
  return (
    <>
      ...
      <label className="form-label"> Lumpsum Investment Withdrawals and Additions </label>
      <br />
        
        
  <button type="button" className="btn btn-outline-success"
      onClick={() => { setLumpsumInvestmentWithdrawalsModal(true); }}
  >
      ...
      <Modal
        ...
        onHide={() => { setLumpsumInvestmentWithdrawalsModal(false) }}
        backdrop="static"
        className="modal-xl"
        keyboard={false}
      >
              ...
              <Modal.Body>
                ...
                <div className="row">
                  ...
                  <div className="col-md-3">
                    <label htmlFor="InvestmentAction" className="form-label">Investment Action</label>
                    <Field as="select" className="form-select shadow inputDesign" id="InvestmentAction"
                    ...
                    <ErrorMessage component="div" className="text-danger fw-bold" name="InvestmentAction" />
                  </div>
                  ...
                  <div className="col-md-3">
                    ...
                    <Field as="select" className="form-select shadow inputDesign" id="InvestmentAssets"
                      ...
                      <option value="Gift/Capital Return">Gift/Capital Return</option>
                    </Field>
                ...
                <div className="row">
                  ...
                  <div className="col-md-3">
                    ...
                    <Field as="select" className="form-select shadow inputDesign" id="FundsCredit"
                      ...
                      <option value="Term Deposits">Term Deposits</option>
                      <option value="Investment Loan">Investment Loan</option>
                      <option value="Trust Bank Account">Trust Bank Account</option>
                    </Field>
              ...
              <Modal.Footer>
                <div className="col-md-12">
                  ...
                  <button
                    ...
                    onClick={() => { setLumpsumInvestmentWithdrawalsModal(false) }}
                  >
                    Cancel
                  </button>
                </div>
