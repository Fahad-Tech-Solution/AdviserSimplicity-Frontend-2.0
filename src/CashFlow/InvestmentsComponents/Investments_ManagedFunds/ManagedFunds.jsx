...
const ManagedFunds = () => {
  ...
  let validationSchema = Yup.object({
    ...
    ClientOpeningValue: Yup.number().when("ClientEdit", {
      ...
      otherwise: Yup.number().min(1, "Must be a positive number").nullable(true),
    }),
    ClientCostBase: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
...
        }),
    ...
    ClientOngoingFees: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
    ...
    PartnerOpeningValue: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
    ...
    PartnerCostBase: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
    ...
    PartnerRegularContributions: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
...
        }),
    ...
    PartnerOngoingFees: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
    ...
    //Joint Validation 
    JointOpeningValue: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
    ...
    JointCostBase: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
    ...
    JointRegularContributions: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
...
        }),
    ...
    JointOngoingFees: Yup.number().when("ClientEdit", {
      is: (val) => val && val.length === 3,
      then: Yup.number()
        .required("Required")
        .min(1, "Must be a positive number"),
  ...
  let onSubmit = (values) => {
    ...
    ClientCostBase:values.ClientCostBase,
    ...
    JointOngoingFees:values.JointOngoingFees,
                              ...
                              <div className="form-check form-switch m-0 p-0 ">
                                <div className="radiobutton">
                                  <input type="radio" name="ClientEditReinvest" id="ClientEditReinvest1"
                                    onChange={handleChange} value="Yes"
                                    checked={values.ClientEditReinvest == "Yes"} disabled={values.ClientEdit === "Yes" ? false : true} />
                                  ...
                                  <input type="radio" name="ClientEditReinvest" id="ClientEditReinvest2"
                                    ...
                                    checked={values.ClientEditReinvest == "No"}  disabled={values.ClientEdit === "Yes" ? false : true}/>
                            ...
                            <div className="col-md-3">
                              <div className="mb-3">
                                ...
                                <Field
                                  ...
                                  id="PartnerGrowth"
                                  name='PartnerGrowth'
                                  placeholder="Partner Growth"
                                  disabled
                                />
                                <ErrorMessage component='div' className="text-danger fw-bold" name='PartnerGrowth' />
                              </div>
                            </div>
                                ...
                                <div className="form-check form-switch m-0 p-0 ">
                                  <div className="radiobutton">
                                    <input type="radio" name="PartnerEditReinvest" id="PartnerEditReinvest1"
                                      onChange={handleChange} value="Yes"
                                      checked={values.PartnerEditReinvest == "Yes"}  disabled={values.PartnerEdit === "Yes" ? false : true} />
                                    ...
                                    <input type="radio" name="PartnerEditReinvest" id="PartnerEditReinvest2"
                                      ...
                                      checked={values.PartnerEditReinvest == "No"}   disabled={values.PartnerEdit === "Yes" ? false : true} />
                            ...
                            <div className="col-md-3">
                              <div className="mb-3">
                                ...
                                <Field
                                  ...
                                  id="JointGrowth"
                                  name='JointGrowth'
                                  placeholder="Joint Growth"
                                  disabled
                                />
                                <ErrorMessage component='div' className="text-danger fw-bold" name='JointGrowth' />
                              </div>
                            </div>
                            ...
                            <div className="col-md-3">
                              <div className="mb-3">
                                ...
                                <Field
                                  ...
                                  id="JointFranking"
                                  name='JointFranking'
                                  placeholder="Joint Franking"
                                  disabled
                                />
                                <ErrorMessage component='div' className="text-danger fw-bold" name='JointFranking' />
                              </div>
                            </div>
                                ...
                                <div className="form-check form-switch m-0 p-0 ">
                                  <div className="radiobutton">
                                    <input type="radio" name="JointEditReinvest" id="JointEditReinvest1"
                                      onChange={handleChange} value="Yes"
                                      checked={values.JointEditReinvest == "Yes"} disabled={values.JointEdit === "Yes" ? false : true} />
                                    ...
                                    <input type="radio" name="JointEditReinvest" id="JointEditReinvest2"
                                      ...
                                      checked={values.JointEditReinvest == "No"} disabled={values.JointEdit === "Yes" ? false : true} />
