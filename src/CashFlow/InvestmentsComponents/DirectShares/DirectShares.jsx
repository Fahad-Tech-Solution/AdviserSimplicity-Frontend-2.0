...
        }),
    ...
    PartnerCostBase:Yup.number().when("PartnerEdit", {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
      .test(
        "Is positive?",
...
        }),
    ...
    PartnerOngoingFees:Yup.number().when("PartnerEdit", {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
      .test(
        "Is positive?",
    ...
    JointCostBase:Yup.number().when("JointEdit", {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
      .test(
        "Is positive?",
...
        }),
    ...
    JointOngoingFees:Yup.number().when("JointEdit", {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
      .test(
        "Is positive?",
                    ...
                    <Form>
                      <Modal.Body>
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-3">
                            <div className="mb-3">
                              <label htmlFor="ClientInvestmentReturn" className="form-label">
                                Investment Return 
                              </label>
                              <Field
                                id="ClientInvestmentReturn"
                                name='ClientInvestmentReturn'
                              ...
                              <ErrorMessage component='div' className='text-danger fw-bold' name="ClientInvestmentReturn" />
                            </div>
                          </div>
                        ...
                        <div>
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-3">
                              <div className="mb-3">
                                <label htmlFor="PartnerInvestmentReturn" className="form-label">
                                  Investment Return 
                                </label>
                                <Field
                                  id="PartnerInvestmentReturn"
                                  name='PartnerInvestmentReturn'
                                  className="form-select shadow  inputDesign"
                                  as='select'
                                  disabled={values.PartnerEdit === "Yes" ? false : true}
                                ...
                                <ErrorMessage component='div' className='text-danger fw-bold' name="PartnerInvestmentReturn" />
                              </div>
                            </div>
                        ...
                        <div>
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-3">
                              <div className="mb-3">
                                <label htmlFor="JointInvestmentReturn" className="form-label">
                                  Investment Return 
                                </label>
                                <Field
                                  id="JointInvestmentReturn"
                                  name='JointInvestmentReturn'
                                  className="form-select shadow  inputDesign"
                                  as='select'
                                  disabled={values.JointEdit === "Yes" ? false : true}
                                ...
                                <ErrorMessage component='div' className='text-danger fw-bold' name="JointInvestmentReturn" />
                              </div>
                            </div>
