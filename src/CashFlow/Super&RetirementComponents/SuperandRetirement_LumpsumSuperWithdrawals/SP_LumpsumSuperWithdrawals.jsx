...
const SP_LumpsumSuperWithdrawals = () => {
  let [SuperWithdrawalsModal, setSuperWithdrawalsModal] = useState(false);
  let [SuperWithdrawals, setSuperWithdrawals] = useState([]);
...
        }),
  ...
  function onSubmit(values, { resetForm }) {
    ...
    setSuperWithdrawals([...SuperWithdrawals, data]);
    resetForm();
  }
  ...
  return (
    ...
    <label className="form-label"> Lumpsum Super Withdrawals </label>
    <br />

      <button type="button" className="btn btn-outline-success"
        onClick={() => { setSuperWithdrawalsModal(true); }}
      >
      ...
      <Modal
        show={SuperWithdrawalsModal}
        onHide={() => { setSuperWithdrawalsModal(false) }}
        backdrop="static"
        className="modal-xl"
        keyboard={false}
      >
                  ...
                  <div className="col-md-12">
                    <div className="table-responsive my-3">
                      <table className="table table-bordered table-hover text-center">
                        ...
                        <tbody>
                          {SuperWithdrawals.map((elem, index) => {
                            return (
                              <tr>
              ...
              <Modal.Footer>
                <div className="col-md-12">
                  ...
                  <button
                    ...
                    onClick={() => { setSuperWithdrawalsModal(false) }}
                  >
                    Cancel
                  </button>
                </div>
...
export default SP_LumpsumSuperWithdrawals;
