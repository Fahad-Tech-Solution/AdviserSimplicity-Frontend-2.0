...
const SP_LumpsumSuperContributions = () => {
  let [SuperContributionsModal, setSuperContributionsModal] = useState(false);
  let [SuperContributions, setSuperContributions] = useState([]);
...
        }),
  ...
  function onSubmit(values, { resetForm }) {
    ...
    setSuperContributions([...SuperContributions, data]);
    resetForm();
  }
  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={() => {
          setSuperContributionsModal(true);
        }}
      >
      ...
      <Modal
        show={SuperContributionsModal}
        onHide={() => {
          setSuperContributionsModal(false);
        }}
        backdrop="static"
        className="modal-xl"
        keyboard={false}
              ...
              <Modal.Body>
                ...
                <div className="row">
                  <div className="col-md-3">
                    <label htmlFor="InvestmentAsset" className="form-label">
                      Investment Asset
                    </label>
                    <Field
                      as="select"
                    ...
                    >
                      ...
                      <option value="Super Fund 1(Client)">
                        Super Fund 1(Client)
                      </option>
                      <option value="Super Fund 2(Client)">
                        Super Fund 2(Client)
                      </option>
                      <option value="Super Fund 1(Partner)">
                        Super Fund 1(Partner)
                      </option>
                      <option value="Super Fund 2(Partner)">
                        Super Fund 2(Partner)
                      </option>
                    </Field>
                    <ErrorMessage
                      component="div"
                ...
                {/* Table */}
                {/* Handle member coloumn option client and partner */}
                <div className="row">
                    ...
                    <div className="table-responsive my-3">
                      <table className="table table-bordered table-hover text-center">
                        <thead className="text-light" id="tableHead">
                          <tr>
                            {/* <th>Member</th>  this need to be fixed*/}
                        ...
                        <tbody>
                          {SuperContributions.map((elem, index) => {
                            return (
                              <tr>
...
export default SP_LumpsumSuperContributions;
