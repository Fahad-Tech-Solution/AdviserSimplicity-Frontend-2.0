...
const DirectProperty_InvestmentPropertyLoanRepayments = () => {
  let [LoanRepaymentsModal, setLoanRepaymentsModal] = useState(false);
  let [LoanRepayments, setLoanRepayments] = useState([]);
  ...
  let validationSchema = Yup.object().shape({
    InvestmentLoan: Yup.string().required("Required"),
  ...
  function onSubmit(values, { resetForm }) {
    console.log(values);
    let data = {
      InvestmentLoan: values.InvestmentLoan,
    ...
    setLoanRepayments([...LoanRepayments, data]);
    resetForm();
  }
  ...
  return (
    <div>
      ...
      <label className="form-label">Investment Property Loan Repayments</label>
      <br />
      <button type="button" className="btn btn-outline-success"
        onClick={() => { setLoanRepaymentsModal(true); }}
      >
      ...
      <Modal
        show={LoanRepaymentsModal}
        onHide={() => { setLoanRepaymentsModal(false) }}
        backdrop="static"
        className="modal-xl"
        keyboard={false}
      >
              ...
              <Modal.Body>
                ...
                <div className="row">
                  ...
                  <div className="col-md-3">
                    <label htmlFor="InvestmentLoan" className="form-label">Investment Loan</label>
                    <Field as="select" className="form-select shadow inputDesign" id="InvestmentLoan"
                      name="InvestmentLoan"  >
                      <option value="">Select</option>
                      <option value="Investment Loan">Investment Loan 1</option>

                    </Field>
                    <ErrorMessage component="div" className="text-danger fw-bold" name="InvestmentLoan" />
                  </div>
                  ...
                  <div className="col-md-3">
                    ...
                    <ErrorMessage component="div" className="text-danger fw-bold" name="Balance" />
                  </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-3">
                    <label htmlFor="Funds" className="form-label">Funds Taken From</label>
                    <Field as="select" className="form-select shadow inputDesign" id="Funds"
                      name="Funds">
                      <option value="">Select</option>
                      <option value="Cash flow">Cash flow</option>
                     
                      <option value="Client's Cash Account">Client's Cash Account</option>
                   
                      <option value="Partner's Cash Account">Partner's Cash Account</option>
                     
                      <option value="Joint's Cash Account">Joint Cash Account</option>
                   

                    </Field>
                    <ErrorMessage component="div" className="text-danger fw-bold" name="Funds" />
                  </div>
                </div>
                      ...
                      <table className="table table-bordered table-hover text-center">
                        <thead className="text-light" id="tableHead">
                          <tr>
                            ...
                            <th>To Year</th>
                            <th>Indexation</th>
                            <th>Funds Taken From</th>
                            <th>Operations</th>

                          </tr>
                        </thead>
                        <tbody>
                          {LoanRepayments.map((elem, index) => {
                            return (
                              <tr>
                                <td>{elem.InvestmentLoan}</td>
              ...
              <Modal.Footer>
                <div className="col-md-12">
                  ...
                  <button
                    ...
                    onClick={() => { setLoanRepaymentsModal(false) }}
                  >
                    Cancel
                  </button>
                </div>
...
export default DirectProperty_InvestmentPropertyLoanRepayments;
