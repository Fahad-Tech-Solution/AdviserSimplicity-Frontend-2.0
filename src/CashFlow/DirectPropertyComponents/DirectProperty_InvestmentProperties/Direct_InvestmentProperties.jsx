...
const Direct_InvestmentProperties = () => {
  ...
  const [investmentPropertyList, setinvestmentPropertyList] = useState([]);
  ...
  let Investment_validationSchema = Yup.object({
    ...
    ConvertPPRYear: Yup.string().required("Required"),
    ...
    AnnualExpenses: Yup.number().required("Required").test(
      "Is positive?",
      "Must be a positive number",

      (value) => value > 0
    ),
    IndexationExpenses: Yup.string().required("Required"),
    ...
    ClientBorrowings: Yup.number().when('loanAttachedradio', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    PartnerBorrowings: Yup.number().when('loanAttachedradio', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
    ...
    MinimumRepayments: Yup.number().when('loanAttachedradio', {
      is: (val) => val && val.length == 3,
      then: Yup.number().required("Required")
        .test(
          "Is positive?",
  ...
  let Investment_onSubmit = (values) => {
    ...
    let data = {
      ...
      ValueOfProperty: values.ValueOfProperty,
      State: values.State,
      YearPurchase: values.YearPurchase,
      OtherCosts: values.OtherCosts,
      ConvertPPRYear: values.ConvertPPRYear,
      ExpectedRental: values.ExpectedRental,
      WeeklyRentalIncome: values.WeeklyRentalIncome,
      Indexation: values.Indexation,
      AnnualExpenses: values.AnnualExpenses,
      IndexationExpenses: values.IndexationExpenses,
      OngoingAgentFees: values.OngoingAgentFees,
      ExpectedGrowthRate: values.ExpectedGrowthRate,
      SellPropertyYear: values.SellPropertyYear,
      EstimatedFutureCost: values.EstimatedFutureCost,
      CurrentBalance: values.CurrentBalance,
      ClientBorrowings: values.ClientBorrowings,
      PartnerBorrowings: values.PartnerBorrowings,
      LoanType: values.LoanType,
      LoanTerm: values.LoanTerm,
      InterestPeriod: values.InterestPeriod,
      InitialInterestRate: values.InitialInterestRate,
      DeductibleInterest: values.DeductibleInterest,
      ApplyMinimumRepayments: values.ApplyMinimumRepayments,
      ActualAnnualRepayments: values.ActualAnnualRepayments,
      RepayLoan: values.RepayLoan,
      loanAttachedradio: values.loanAttachedradio,
      MinimumRepayments: values.MinimumRepayments,
    };

console.log(data)
    setinvestmentPropertyList([...investmentPropertyList,data])
  };
  ...
  let Investment_onSubmit_Modal = (values) => {
    let myData = {
      ...
      TotalPropertyExpenses: ((parseFloat(values.BodyCorporateFees2) || 0) + (parseFloat(values.CouncilRates2) || 0)
      +(parseFloat(values.GardeningAndLawnmowing2)||0)+(parseFloat(values.Insurance2)||0)
      +(parseFloat(values.LandTax2)||0)+(parseFloat(values.RepairsAndMaintenance2)||0)+(parseFloat(values.WaterCharges2)||0)
      +(parseFloat(values.Other2)||0)+(parseFloat(values.TelephoneAndInternet2)||0)
      +(parseFloat(values.ProfessionalFees2)||0)+(parseFloat(values.AllOther)||0)), //readonly
                      ...
                      <Modal.Body>
                        ...
                        <div>
                          ...
                          <div className="row">
                            <div className="col-md-3">
                              <div className="mb-3">
                                <label htmlFor="ConvertPPRYear" className="form-label">
                                  Convert into PPR Year
                                </label>
                                <Field
                                  id="ConvertPPRYear"
                                  name='ConvertPPRYear'
                                ...
                                <ErrorMessage component='div' className='text-danger fw-bold' name="ConvertPPRYear" />
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="row">
                                        ...
                                        <div className="col-md-6">
                                          <div className="mb-3">
                                            ...
                                            <Field
                                              ...
                                              readOnly
                                              value={((parseFloat(values.BodyCorporateFees2) || 0) + (parseFloat(values.CouncilRates2) || 0)
                                                +(parseFloat(values.GardeningAndLawnmowing2)||0)+(parseFloat(values.Insurance2)||0)
                                                +(parseFloat(values.LandTax2)||0)+(parseFloat(values.RepairsAndMaintenance2)||0)+(parseFloat(values.WaterCharges2)||0)
                                                +(parseFloat(values.Other2)||0)+(parseFloat(values.TelephoneAndInternet2)||0)
                                                +(parseFloat(values.ProfessionalFees2)||0)+(parseFloat(values.AllOther)||0))}
                                            />
                                          </div>
                                        </div>
                                        <div className="col-md-6">
                          ...
                          <div className="col-md-3">
                            <div className="mb-3">
                              <label htmlFor="IndexationExpenses" className="form-label">
                                Indexation of Expenses
                              </label>
                              <Field
                                id="IndexationExpenses"
                                name='IndexationExpenses'
                                className="form-select shadow inputDesign"
                                as='select'
                              >
                                <option value="">Select</option>
                              ...
                              <ErrorMessage component='div' className='text-danger fw-bold' name="IndexationExpenses" />
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-6">
                                <div className="mb-3">
                                  <label
                                    htmlFor="ClientBorrowings"
                                    className="form-label"
                                  >
                                    Client % of Borrowings
                                  </label>
                                  <Field
                                    type="number"
                                    className="form-control shadow inputDesign"
                                    id="ClientBorrowings"
                                    name="ClientBorrowings"
                                    placeholder="Client % of Borrowings"
                                    onChange={(e) => {
                                      const newValue = parseFloat(e.target.value) || 0;
                                      handleChange(e);
                                      if (newValue <= 100) {
                                        handleChange({
                                          target: { name: 'PartnerBorrowings', value: 100 - newValue },
                                        });
                                      }
                                    }}
                                  />
                            ...
                            <div className="row">
                              <div className="col-md-6">
                                <div className="mb-3">
                                  <label
                                    htmlFor="PartnerBorrowings"
                                    className="form-label"
                                  >
                                    Partner % of Borrowings
                                  </label>
                                  <Field
                                    type="number"
                                    className="form-control shadow inputDesign"
                                    id="PartnerBorrowings"
                                    name="PartnerBorrowings"
                                    placeholder="Partner % of Borrowings"
                                    onChange={(e) => {
                                      const newValue = parseFloat(e.target.value) || 0;
                                      handleChange(e);
                                      if (newValue <= 100) {
                                        handleChange({
                                          target: { name: 'ClientBorrowings', value: 100 - newValue },
                                        });
                                      }
                                    }}
                                  />
                          ...
                          <div className="col-md-12">
                            <div className="table-responsive my-3">
                              <table className="table table-bordered table-hover text-center">
                                ...
                                <tbody>
                                  {investmentPropertyList.map((elem, index) => {
                                    return (
                                      <tr>
                                        <td>{elem.YearPurchase}</td>
                                        <td>{elem.ValueOfProperty}</td>
                                        <td>Client{elem.ClientOwnership}%/ Partner{elem.PartnerOwnership}%</td>
                                        <td>{elem.InitialInterestRate}</td>

                                        <td>{elem.AnnualExpenses}</td>
                                        <td>{elem.CurrentBalance}</td>
                                        <td>{ elem.ApplyMinimumRepayments=="Yes" ? "Minimum"  : elem.ActualAnnualRepayments}</td>
                                        <td>
...
export default Direct_InvestmentProperties
