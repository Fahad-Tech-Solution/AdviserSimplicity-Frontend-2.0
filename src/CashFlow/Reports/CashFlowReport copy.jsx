...
const CashFlowReport = () => {
  ...
  const FetchReports = async () => {
    ...
    try {
      ...
      let clientTax = createTaxSection(
        client_Tax,
      ...
      clientTax.unshift(AgeArray[0]);

      setClientData(clientTax);

      let partnerTax = createTaxSection(
        partner_Tax,
        content.cashFlowReport[0].reportsArray.clientTaxPosition
      ).map((item, index) => {
        let section = [
      ...
      partnerTax.unshift(AgeArray[1]);

      setPartnerData(partnerTax);

      let FullCenterlink = [
        ...processedSections.AssetsTestPensionAllowanceData,
        ...processedSections.IncomeTestPensionsAllowancesData,
        ...processedSections.IncomeTestAllowancesData,
        ...processedSections.ClientIncome,
        ...processedSections.PartnerIncome,
        ...processedSections.ClientPayment,
        ...processedSections.PartnerPayment,
      ].map((item, index) => {
        let section = [
          "Assets Test Pension Allowance",
          "Income Test Pensions & Allowances",
          "Income Test Allowances",
          "Client Income",
          "Partner Income",
          "Client Payment",
          "Partner Payment",
