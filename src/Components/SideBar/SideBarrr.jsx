          ...
          <div className="sideBar2 border" style={{ width: sidebarWidth }}>
            ...
            >
              ...
              >
                ...
                {sidebar ? (
                  <span className="ms-2 d-inline-block LeagueSpartanFamily SideItem_Size ">
                    {" "}
                    Dashboard{" "}
                  </span>
                ) : (
            ...
            >
              ...
              >
                <FaPeopleGroup />{" "}
                {sidebar ? (
                  <span className="ms-2 d-inline-block LeagueSpartanFamily SideItem_Size w-75">
                    {" "}
                    CDF Clients{" "}
                  </span>
                ) : (
            ...
            <li className={sidebar ? "mx-0 mb-0 mt-2 p-0" : "text-center"}>
              <Accordion
                className={`${sidebar ? "Custom_Accordion" : "removeLeftBar"}`}
              >
                <Accordion.Item eventKey="0">
                  <Accordion.Header>
                    ...
                    &nbsp;&nbsp;{" "}
                    {sidebar ? (
                      <span className="LeagueSpartanFamily SideItem_Size font-weight-bold p-0 m-0 w-auto">
                        Discovery{" "}
                      </span>
                    ) : (
                      ""
                  ...
                  <Accordion.Body>
                    <div
                      className={`w-100 px-3 Custom_hover ${
                        CurrentP === "/All-Clients" && "active"
                      }`}
                      onClick={() => {
                        setOptRender("Opt1");
                    ...
                    <div
                      className={`w-100 px-3 Custom_hover ${
                        CurrentP === "/Goals-And-Objectives" && "active"
                      }`}
                      onClick={(e) => {
                        Navigate("/Goals-And-Objectives");
                      }}
                      id="Goals"
                    >
                      <NavLink
                    ...
                    <div
                      className={`w-100 px-3 Custom_hover ${
                        CurrentP === "/PersonalDetail" && "active"
                      }`}
                      onClick={() => {
            ...
            <li className={sidebar ? "m-0 p-0" : " text-center"}>
              <Accordion
                className={`${sidebar ? "Custom_Accordion" : "removeLeftBar"} `}
              >
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <div
                      className={`w-100 px-3 Custom_hover ${
                        CurrentP === "/Cash-Flow" && "active"
                      }`}
                      onClick={() => {
                        setOptRender("Opt3");
                        localStorage.setItem("OptionRender", "Opt3");
                        Navigate("/Cash-Flow/AllUsers");
                      }}
                      id="cashFlow"
                    >
                      <NavLink
                    ...
                    <div
                      className={`w-100 px-3 Custom_hover ${
                        CurrentP === "Scenario" && "active"
                      }`}
                      onClick={() => {
                        setCurrentP("Scenario");
                      }}
                      id="Scenario"
                    >
                      <NavLink
                    ...
                    <div
                      className={`w-100 px-3 Custom_hover ${
                        CurrentP === "ManageTask" && "active"
                      }`}
                      onClick={() => {
                        setCurrentP("ManageTask");
                      }}
                      id="ManageTask"
                    >
                      <NavLink
                    ...
                    <div
                      className={`w-100 px-3 Custom_hover ${
                        CurrentP === "ManageDocument" && "active"
                      }`}
                      onClick={() => {
                        setCurrentP("ManageDocument");
                      }}
                      id="ManageDocument"
                    >
                      <NavLink
            ...
            <li className={sidebar ? "m-0 d-none" : "text-center d-none"}>
