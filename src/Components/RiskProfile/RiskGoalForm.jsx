...
const RiskGoalForm = (props) => {
  ...
  const onSubmit = async (values) => {
    ...
    props.setFieldValue(
      `${props.modalObject.innerKey}.riskGoal`,
      values[`${props.modalObject.innerKey}`].riskGoal
    );
    props.setFieldValue(
      `${props.modalObject.innerKey}.riskDescription`,
      values[`${props.modalObject.innerKey}`].riskDescription
    );
    props.setFieldValue(
      `${props.modalObject.innerKey}.addNoteDescription`,
      values[`${props.modalObject.innerKey}`].addNoteDescription
    );
  ...
  let fillTheValues = (setFieldValue) => {
    ...
    setFieldValue(
      `${props.modalObject.innerKey}.riskGoal`,
      Data[`${props.modalObject.innerKey}`].riskGoal
    );
    setFieldValue(
      `${props.modalObject.innerKey}.riskDescription`,
      Data[`${props.modalObject.innerKey}`].riskDescription
    );
    setFieldValue(
      `${props.modalObject.innerKey}.addNoteDescription`,
      Data[`${props.modalObject.innerKey}`].addNoteDescription
    );
              ...
              <Form>
                <div className="col-md-12 text-center">
                    ...
                    <Modal.Body>
                      <div className="row">
                        <div className="col-md-12">
                          ...
                          >
                            Please provide a reason/description of why you are
                        ...
                        <div className="col-md-12">
                          ...
                          <Field
                            ...
                            id="addNoteDescription"
                            name={`${props.modalObject.innerKey}.addNoteDescription`}
                            className="form-control inputDesignDoubleInput mt-3"
                          />
                        </div>
                      </div>
                  ...
                  <Row className="justify-content-center">
                      ...
                      return (
                        <div className="col-md-4 px-2 pb-3 d-flex ">
                          <div className="flex-grow-1 d-flex">
                            <div
                              className={`${
                                values[`${props.modalObject.innerKey}`]
                                  .riskGoal == elem.value
                                  ? "customBorder p-3"
                                  : "border p-3"
                              } 
                    ...
                    <div className="col-md-12">{parse(disc)}</div>
                  </Row>
                </div>
              </Form>
            );
