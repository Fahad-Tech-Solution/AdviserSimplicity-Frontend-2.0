...
const RiskProfileCards = (props) => {
    ...
    const { setFieldValue, values, handleChange, confirmFlag, setConfirmFlag, setValues } = props.Obj;
            ...
            <div className="row px-0 m-0 ">
                ...
                <div className='row justify-content-center align-items-stretch'>
                    <div className='col-md-6 my-3'>
                        <Card className="py-4 shadow borderOverAll d-flex" style={{ borderRadius: "20px", height: "100%" }}>
