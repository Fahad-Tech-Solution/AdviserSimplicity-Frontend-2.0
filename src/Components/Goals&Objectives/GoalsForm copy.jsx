              ...
              <div className="mt-4">
                    ...
                    <tr>
                      <td style={{ maxWidth: "150px" }}>
                        <Field
                          ...
                          onChange={(e) => {
                            autoDescription(e, setFieldValue, handleChange);
                          }}
                        >
                          ...
                          <option value={"Personal Insurance"}>
                            Personal Insurance{" "}
                          </option>
                ...
                {showDropDown || (
                  <div className="col-md-12 pe-3">
                    ...
                    <textarea
                      className="goalsPara form-control inputDesignDoubleInput d-none"
                    ...
                    {props.modalObject.descriptionArray.map((elem, index) => (
                      <>
                        ...
                        <Dropdown.Item
                          eventKey={index}
                          onClick={() => {
                            StoreText(elem, setFieldValue);
                          }}
                          className="text-wrap dropDownHover goalsPara"
                        >
                          {parse(elem.text)}
                        </Dropdown.Item>
                      </>
