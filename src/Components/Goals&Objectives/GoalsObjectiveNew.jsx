                                ...
                                if (GQSObj[goal.key] === "Yes") {
                                    return (
                                        <div className={`col-md-3  mb-4`} key={index}>
                                            <Card className="py-4 shadow GoalsobjectiveCard px-4" style={{ borderRadius: "20px", height: "100%" }}>
                                                    ...
                                                    {({ values, setFieldValue }) => {
                                                        return (<Form className='smallerInput'>
                                                            ...
                                                            <Field
                                                                ...
                                                                name={"estimatedValue"}
                                                                readOnly
                                                                value={goalsDetail[goal.key]?.estimatedValue ? `${goalsDetail[goal.key].estimatedValue}` : ""}
                                                            />
