...
const VerifyEmail = () => {
  ...
  function generate() {
    ...
    for (let i = 0; i <= characterLength; i++) {
      if (includeUppercase) {
        result += charUppercase.charAt(
          Math.floor(Math.random() * charUppercase.length)
        );
      }

      if (includeLowercase) {
        result += charLowercase.charAt(
          Math.floor(Math.random() * charLowercase.length)
        );
      }

      if (includeNumber) {
        result += charNumber.charAt(
          Math.floor(Math.random() * charNumber.length)
        );
      }

      if (includeSpecial) {
        result += charSpecial.charAt(
                          ...
                          <div className="row my-3 justify-content-center">
                            <div className="col-md-10">
                              ...
                              <p className="p-0 mt-2">
                                An OTP is Send on: <br /> {VerifyCodeData.email}
                              </p>
                            </div>
                          </div>
                        ...
                        <React.Fragment>
                          <div className="row mt-2">
                            ...
                            <div className="col-md-10">
                              ...
                              <InputGroup>
                                <Form.Control
                                  className="form-control box-shadow-0 border-end-0"
                                ...
                                />
                                <InputGroup.Text
                                  className="bg-white border-start-0 curserPointer"
                                  onClick={() =>
                            ...
                            <div className="col-md-10">
                              ...
                              <InputGroup>
                                <Form.Control
                                  className="form-control box-shadow-0 border-end-0"
                                  type={
                                    confirmPasswordSwitch ? "text" : "password"
                                  }
                                  id="CPassword"
