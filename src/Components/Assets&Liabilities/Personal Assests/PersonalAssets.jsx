...
const PersonalAssetsLiabilities = () => {
  ...
  let GetApiFunction = async (email) => {
    try {
      let ClientOther = await axios.get(
        `${DefaultUrl}/api/Client-PersonalAssets`
      );
  ...
  let deleteOption = (elem, deleteData) => {
    if (deleteData === "Contents") {
      ...
      axios
        .patch(
          `${DefaultUrl}/api/Client-PersonalAssets/Update/${elem.Email}`,
          elem
        )
        .then((res) => {
          console.log("Contents is Deleted");
          setFormData(elem);
        });
      ...
      axios
        ...
        .then((res) => {
          console.log("Motor Vehicle 1 is Deleted");
          setFormData(elem);
        });
      ...
      axios
        ...
        .then((res) => {
          console.log("Motor Vehicle 2 is Deleted");
          setFormData(elem);
        });
      ...
      axios
        ...
        .then((res) => {
          console.log("Caravan is Deleted");
          setFormData(elem);
        });
  ...
  let onSubmit = (values) => {
    ...
    if (postFlag === false) {
      axios
        .post(
          `${DefaultUrl}/api/Client-PersonalAssets/Update/${personalAssetsObj.Email}`,
          personalAssetsObj
        )
        .then((res) => {
      ...
      axios
        .post(`${DefaultUrl}/api/Client-PersonalAssets/Add`, personalAssetsObj)
        .then((res) => {
          console.log("Personal Assets Has Been Added");
          setFormData(personalAssetsObj);
        });
                            ...
                            <div className="row">
                              ...
                              >
                                <table className="table table-bordered table-hover text-center">
                                  ...
                                  <tbody>
                                    {formData.ContentsPA !== "" &&
                                      formData.ContentsPA !== undefined &&
                                      formData.ContentsPA > 0 && (
                                        <tr>
                                          <td>Contents</td>
                                          <td>{formData.ContentsPA}</td>
                                          <td>
                                            <CustomDropDown
                                              Operations={AssetsOperation}
                                              Delete={"Contents"}
                                              Data={formData}
                                              FormikFun={setValues}
                                            />
                                    ...
                                    {formData.MotorVehicle1PA !== "" &&
                                      formData.MotorVehicle1PA !== undefined &&
                                      formData.MotorVehicle1PA > 0 && (
                                        <tr>
                                    ...
                                    {formData.MotorVehicle2PA !== "" &&
                                      formData.MotorVehicle2PA !== undefined &&
                                      formData.MotorVehicle2PA > 0 && (
                                        <tr>
                                    ...
                                    {formData.CaravanPA !== "" &&
                                      formData.CaravanPA !== undefined &&
                                      formData.CaravanPA > 0 && (
                                        <tr>
                                          <td>Caravan</td>
