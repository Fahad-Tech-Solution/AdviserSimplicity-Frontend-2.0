...
const OwnFamilyHome = (props) => {
    ...
    const familyHome =
        questionDetail?.familyHome && Object.keys(questionDetail.familyHome).length > 0
    ...
    const onSubmit = async (values) => {
        ...
        try {
            ...
            openNotificationSuccess(
                ...
                "topRight",
                "Error Notification",
                `Data of "${props.modalObject?.title || "Family Home"}" is not Saved. Please try again.`
            );
        }
    };
                ...
                return (
                    ...
                    >
                        <HomeLoan
                            ...
                            onSave={(loanValues) => {
                                setFieldValue("loanAmount", loanValues.loanBalance || "");
                                setFieldValue("annualRepayments", loanValues.annualRepayments || "");
