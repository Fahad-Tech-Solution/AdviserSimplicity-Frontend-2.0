...
const SuperFunds = (props) => {
  ...
  let initialValues = superAnnuationIssues[props.modalObject.Input].length
    ? { NumberOfMap: superAnnuationIssues[props.modalObject.Input].length }
    : { NumberOfMap: "" };
  ...
  useEffect(() => {
    if (
      superAnnuationIssues[props.modalObject.Input] &&
      superAnnuationIssues[props.modalObject.Input].length
    ) {
      let arr = [];

      for (
        let i = 0;
        i < superAnnuationIssues[props.modalObject.Input].length;
        i++
      ) {
        arr.push("");
      }
  ...
  let onSubmit = async (values) => {
    ...
    obj[DataOf + "Total"] = newEntries.reduce(
      (total, entry) => total + entry.annualAdvice,
      0
    );
                      ...
                      <Table striped bordered responsive hover>
                        <thead>
                          <tr>
                            ...
                            <th>Fund Name</th>
                            <th>
                              Member Number & Details - have a ? explaining what
                              info is in this box
                            </th>
                                  ...
                                  <InputGroup className="mb-3">
                                    ...
                                    <Button
                                      ...
                                      onClick={() => {
                                        handleInnerModal(
                                          "Portfolio Value",
                                          "How many Underlying Investments do you have ?",
                                          "portfolioArray",
                                          "portfolioValue",
                                          "totalPortfolioCost",
                                    ...
                                    {values[`groupInsurance${i}`] === "Yes" && (
                                      <Button
                                        ...
                                        onClick={() => {
                                          handleInnerModal(
                                            "Insurances Attached",
                                            "How many Group Insurance you have :",
                                            "groupInsuranceArray",
                                            "",
                                            "",
