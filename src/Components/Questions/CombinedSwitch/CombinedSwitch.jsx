          ...
          <div className={`row justify-content-center align-items-center my-2`}>
            <div className="col-12 p-0 ">
              <div className="d-flex flex-column-reverse justify-content-center align-items-center gap-2">
                <label className="d-block" htmlFor={"joint" + elem.key}>
                ...
                <label
                  ...
                  onClick={() => {
                    OpenModal(elem.title, "client", elem.key);
                  }}
                >
                  <div>
      ...
      >
        ...
        >
          ...
          <div className={`row justify-content-center align-items-center my-2`}>
            <div className="col-12 p-0 ">
              <div className="d-flex flex-column-reverse justify-content-center align-items-center gap-2">
                <label className="d-block" htmlFor={"client" + elem.key}>
                  {localStorage.getItem("UserName") || "You"}{" "}
                </label>
      ...
      >
        ...
        >
          ...
          <input
            ...
            name={"client" + elem.key}
            value={
              questionDetail && questionDetail[elem.key]?.currentValue
                ? questionDetail[elem.key].currentValue
                : ""
            }
          />
          <div className={`row justify-content-center align-items-center my-2`}>
            <div className="col-12 p-0 ">
              <div className="d-flex flex-column-reverse justify-content-center align-items-center gap-2">
                <label className=" d-block " htmlFor={"partner" + elem.key}>
                  Loan Balance{" "}
                </label>
              </div>
            </div>
          ...
          <input
            ...
            value={
              questionDetail &&
              questionDetail[elem.key]?.HomeLoanModal?.loanBalance
                ? questionDetail[elem.key].HomeLoanModal.loanBalance
                : ""
            }
          />
