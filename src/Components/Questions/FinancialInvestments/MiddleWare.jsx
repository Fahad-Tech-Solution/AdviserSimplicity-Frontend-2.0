...
const MiddleWare = (props) => {
  ...
  let attrebuteSet = switchArray.includes(props.modalObject.title)
    ? true
    : false;
    ...
    try {
      ...
      const updateCostBase = (field, entries, costBaseField) => {
        ...
        checkValues(
          BankAccountFinance,
          setFieldValue,
          { name: field, value: BankAccountFinance[field] || "" },
          ""
        );
      };
      ...
      if (localStorage.getItem("UserStatus") === "Married") {
        ...
        try {
          ...
          console.error(
            "Error calculating partner and joint cost bases:",
            error
          );
        }
      }
  ...
  let onSubmit = async (values) => {
    ...
    if (
      ...
      try {
        ...
        let jointCurrentBalance = parseFloat(
          obj.jointCurrentBalance.replace(/[^0-9.-]+/g, "")
        );
      ...
      if (fiftyPercent === 0) {
        ...
        obj.clientTotal = toCommaAndDollar(
          (parseFloat(obj.clientCurrentBalance.replace(/[^0-9.-]+/g, "")) ||
            0) + fiftyPercent
        );
        obj.partnerTotal = toCommaAndDollar(
          (parseFloat(obj.partnerCurrentBalance.replace(/[^0-9.-]+/g, "")) ||
            0) + fiftyPercent
        );
      }
    } else {
  ...
  const rowConfig = attrebuteSet
    ? [
        { type: "plainText", text: "client", styleSet: { width: "50%" } },
        {
          ...
          invalidMessage: ShowError.clientCurrentBalanceError
            ? ShowError.clientCurrentBalanceMessage
            : "",
          callBack: true,
        ...
        },
        {
          ...
          invalidMessage: ShowError.clientCostBaseTempError
            ? ShowError.clientCostBaseTempMessage
            : "",
          callBack: true,
          func: checkValues,
        },
  ...
  const rowConfigPartner = attrebuteSet
    ? [
        { type: "plainText", text: "partner", styleSet: { width: "50%" } },
        {
          ...
          invalidMessage: ShowError.partnerCurrentBalanceError
            ? ShowError.partnerCurrentBalanceMessage
            : "",
          callBack: true,
          inputChangeFunc: checkValues,
          callBackModal: true,
        ...
        },
        {
          ...
          invalidMessage: ShowError.partnerCostBaseTempError
            ? ShowError.partnerCostBaseTempMessage
            : "",
          callBack: true,
          func: checkValues,
        },
  ...
  const rowConfigJoint = attrebuteSet
    ? [
        { type: "plainText", text: "joint", styleSet: { width: "50%" } },
        {
          ...
          invalidMessage: ShowError.jointCurrentBalanceError
            ? ShowError.jointCurrentBalanceMessage
            : "",
          callBack: true,
          inputChangeFunc: checkValues,
          key: "joint",
        ...
        },
        {
          ...
          invalidMessage: ShowError.jointCostBaseTempError
            ? ShowError.jointCostBaseTempMessage
            : "",
          callBack: true,
          func: checkValues,
        },
