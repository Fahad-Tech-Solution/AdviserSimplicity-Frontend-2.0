...
const QuestionCards = (props) => {
  ...
  const componentMapping = {
    ...
    "Regular Living Expenses": <RegularLivingExpenses />, // its Tables Need to be Chenaged
                      ...
                      <div className="row justify-content-center align-items-center my-2">
                        <div className="col-12 p-0 ">
                          <div className="d-flex flex-column-reverse justify-content-center align-items-center gap-2">
                            ...
                            <label
                              role="button"
                              className="mb-0 bg-secondary rounded-circle text-light py-1 px-2"
                              onClick={() => {
                                OpenModalClient2(
                                  elem.title,
                                  "client",
