...
const HolidayHomeLoan = (props) => {
    ...
    useEffect(() => {
        ...
        if (holidayHomeLoan[props.modalObject.Input] && holidayHomeLoan[props.modalObject.Input].length) {

            let arr = []

            for (let i = 0; i < holidayHomeLoan[props.modalObject.Input].length; i++) {
                arr.push("");
            }
    ...
    const fillInitialValues = (setFieldValue) => {
        ...
        if (holidayHomeLoan[props.modalObject.Input] && holidayHomeLoan[props.modalObject.Input].length) {
            ...
            holidayHomeLoan[props.modalObject.Input].forEach((data, i) => {
                if (data) {
    ...
    let onSubmit = async (values) => {
        ...
        try {
            ...
            if (res) {
                console.log(res);
                const updatedData = { ...questionDetail, holidayHomeLoan: res };
...
export default HolidayHomeLoan;
