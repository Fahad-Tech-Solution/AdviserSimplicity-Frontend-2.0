...
const HolidayHome = (props) => {
    ...
    useEffect(() => {
        if (holidayHome[props.modalObject.Input] && holidayHome[props.modalObject.Input].length) {

            let arr = []

            for (let i = 0; i < holidayHome[props.modalObject.Input].length; i++) {
                arr.push("");
            }
    ...
    const fillInitialValues = (setFieldValue) => {
        ...
        if (holidayHome[props.modalObject.Input] && holidayHome[props.modalObject.Input].length) {
            ...
            holidayHome[props.modalObject.Input].forEach((data, i) => {
                if (data) {
    ...
    let onSubmit = async (values) => {
        ...
        try {
            ...
            if (res) {
                console.log(res);
                const updatedData = { ...questionDetail, holidayHome: res };
