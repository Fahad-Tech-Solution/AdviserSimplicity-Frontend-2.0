...
const OwnFamilyHome = (props) => {
    ...
    useEffect(() => {
        if (familyHome[props.modalObject.Input] && familyHome[props.modalObject.Input].length) {

            let arr = []

            for (let i = 0; i < familyHome[props.modalObject.Input].length; i++) {
                arr.push("");
            }
    ...
    const fillInitialValues = (setFieldValue) => {
        ...
        if (familyHome[props.modalObject.Input] && familyHome[props.modalObject.Input].length) {
            ...
            familyHome[props.modalObject.Input].forEach((data, i) => {
                if (data) {
                    setFieldValue(`HomeAddress${i}`, data.HomeAddress || '');
    ...
    let onSubmit = async (values) => {
        ...
        for (let i = 0; i < numberOfMaps; i++) {
            const newEntry = {
                HomeAddress: values[`HomeAddress${i}`] || "",
        ...
        // Check if familyHome and the array at props.modalObject.Input exist
        // const bankAccountArray = familyHome[props.modalObject.Input] || [];
