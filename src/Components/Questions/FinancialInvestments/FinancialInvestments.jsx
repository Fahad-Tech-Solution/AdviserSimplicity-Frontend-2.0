              ...
              <div className="col-md-12 text-center">
                ...
                <div className="row my-3 d-none">
                  <div className="col-md-12">
                    <div className="mb-3 ">
                      <label htmlFor="" className="form-label">
                        Do you have any Money invested Managed Funds or via a
                        Platform?
                      </label>
                      <div className="QuestionIcon">
                      ...
                      <div className="form-check form-switch m-0 p-0 col-md-12 QuestionYesNoCenter ">
                        <div className="radiobutton">
                          ...
                          />
                          <label htmlFor="managedFund" className="label1">
                            <span>No</span>
                          </label>
                          <input
                            type="radio"
                          ...
                          />
                          <label htmlFor="managedFund2" className="label2">
                            <span>Yes</span>
                          </label>
                        </div>
                      </div>
                ...
                <div className="row my-3 d-none">
                  <div className="col-md-12">
                    <div className="mb-3 ">
                      <label htmlFor="" className="form-label">
                        Do you have a Investment Loan (LOC) attached to your
                        shares of Managed Funds?
                      </label>
                      <div className="QuestionIcon">
                      ...
                      <div className="form-check form-switch m-0 p-0 col-md-12 QuestionYesNoCenter ">
                        <div className="radiobutton">
                          ...
                          />
                          <label htmlFor="managedFundsLOC" className="label1">
                            <span>No</span>
                          </label>
                          <input
                            type="radio"
                          ...
                          />
                          <label htmlFor="managedFundsLOC2" className="label2">
                            <span>Yes</span>
                          </label>
                        </div>
                      </div>
                ...
                <div className="row my-3 d-none">
                  <div className="col-md-12">
                    <div className="mb-3 ">
                      <label htmlFor="" className="form-label">
                        Do you have a Margin Loan attached to your shares of
                        Managed Funds?
                      </label>
                      <div className="QuestionIcon">
