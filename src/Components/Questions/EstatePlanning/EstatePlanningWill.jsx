...
const EstatePlanningWill = (props) => {
  ...
  let TBodyRender = (
    ...
    const rowConfig2 = [
      {
        disabled: values.owner.includes("together"),
        name: "yearSetUp",
        type: "number",
        placeholder: "Year set up",
      },
      ...
      {
        disabled: values.owner.includes("together"),
        name: "enduringGuardianship",
        type: "yesno",
      },
      {
        disabled: values.owner.includes("together"),
        name: "testamentaryTrust",
        type: "yesno",
      },
      {
        disabled: values.owner.includes("together"),
                    ...
                    {values.owner.includes("together") && (
                      <label htmlFor="" className="text-end ">
                        <Tooltip
                          placement="top"
                          title={
                            "When yes is selected for Partner for Wills  and POA have an option to copy details from Client Answers for Will  and POA this will apply for when client and partner have a Will together."
                          }
                        >
                          <FaCircleQuestion
                      ...
                      <Table striped bordered responsive hover>
                        <thead>
                          <tr>
                            ...
                            <th>
                              Any specific estate planning requirements/needs?
                            </th>
                          </tr>
                        </thead>
                        <tbody>
