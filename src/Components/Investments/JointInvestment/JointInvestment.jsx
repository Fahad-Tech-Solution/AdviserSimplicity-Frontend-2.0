...
function JointInvestment(prop) {
  ...
  let Client_initialValues = {
    ...
    InvestmentPropertiesJointOwnership: "",
    ...
    InvestmentPropertiesJointBorrowing: "",
  ...
  let Client_validationSchemaInvestmentProperties = Yup.object({
    ...
    InvestmentPropertiesJointOwnership: Yup.number().test(
      "Is positive?",
      "Must be a positive value",
      (value) => value > 0
    ),
    ...
    InvestmentPropertiesJointBorrowing: Yup.number().when(
      "InvestmentPropertiesLoanAttached",
      {
        is: (val) => val && val.length === 3,
        then: Yup.number().test(
  ...
  // let Joined_validationSchemaAssociatedLoan= Yup.object({})
  ...
  let TermDeposit_onSubmit = (values) => {
    ...
    if (TermDepositEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Joined-TermDeposit/Update-Joined-TermDeposit/${TermDepositDetails.Email}`,
          TermDepositDetails
        )
        .then((res) => {
          //Popper Massage
          console.log("Joined Bank Updated Complete");
        });
    } else {
      ...
      axios
        .post(
          `${DefaultUrl}/api/Joined-TermDeposit/Add-Joined-TermDeposit`,
          TermDepositDetails
        )
        .then((res) => console.log("Joined Term Deposit Added Successfully!"));
    }
    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Joined-TermDeposit`).then((res) => {
        console.log("Joined got it");
  ...
  let AustralianShareMarket_onSubmit = (values) => {
    ...
    if (AustralianShareMarketEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Joined-Australian-Market-Share/Update-Joined-Australian-Market-Share/${AustralianShareMarketDetails.Email}/${values.id}`,
      ...
      axios
        .post(
          `${DefaultUrl}/api/Joined-Australian-Market-Share/Add-Joined-Australian-Market-Share`,
          AustralianShareMarketDetails
        )
        .then((res) =>
          console.log("Joined Australian Share Market Added Successfully!")
        );
      console.log(AustralianShareMarketDetails);
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Joined-Australian-Market-Share`).then((res) => {
        console.log("Joined got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let AustralianSharePortfolio_onSubmit = (values) => {
    ...
    if (AustralianSharePortfolioEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Joined-Australian-Share-Portfolio/Update-Joined-Australian-Share-Portfolio/${AustralianSharePortfolioDetails.Email}/${values.id}`,
          AustralianSharePortfolioDetails
        )
        .then((res) => {
          //Popper Massage
          console.log("Joined Australian Share Portfolio Updated Complete");
        });
      setAustralianSharePortfolioEdit(false);
    } else {
      axios
        .post(
          `${DefaultUrl}/api/Joined-Australian-Share-Portfolio/Add-Joined-Australian-Share-Portfolio`,
          AustralianSharePortfolioDetails
        )
        .then((res) =>
          console.log("Joined Australian Share Portfolio Added Successfully!")
        );
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Joined-Australian-Share-Portfolio`).then((res) => {
        console.log("Joined got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let ManagedFunds_onSubmit = (values) => {
    ...
    if (ManagedFundsEdit) {
      ...
      axios
        .patch(
          `${DefaultUrl}/api/Joined-ManagedFunds/Update-Joined-ManagedFunds/${ManagedFundsDetails.Email}/${values.id}`,
          ManagedFundsDetails
        )
        .then((res) => {
          //Popper Massage
          console.log("Joined Managed Share Portfolio Updated Complete");
        });
      ...
      axios
        .post(
          `${DefaultUrl}/api/Joined-ManagedFunds/Add-Joined-ManagedFunds`,
          ManagedFundsDetails
        )
        .then((res) => console.log("Joined Managed Funds Added Successfully!"));
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Joined-ManagedFunds`).then((res) => {
        console.log("Joined got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let ManagedFundsPortfolio_onSubmit = (values) => {
    ...
    if (ManagedFundsLoanEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Joined-ManagedFunds-Portfolio/Update-Joined-ManagedFunds-Portfolio/${ManagedFundsPortfolioDetails.Email}/${values.id}`,
      ...
      axios
        .post(
          `${DefaultUrl}/api/Joined-ManagedFunds-Portfolio/Add-Joined-ManagedFunds-Portfolio`,
          ManagedFundsPortfolioDetails
        )
        .then((res) =>
          console.log("Joined Managed Funds Portfolio Added Successfully!")
        );
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Joined-ManagedFunds-Portfolio`).then((res) => {
        console.log("Joined got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let InvestmentBonds_onSubmit = (values) => {
    ...
    if (InvestmentBondsEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Joined-InvestmentBonds/Update-Joined-Investment-Bonds/${InvestmentBondsDetails.Email}/${values.id}`,
          InvestmentBondsDetails
        )
        .then((res) => {
          //Popper Massage
          console.log("Joined Investment Bonds Updated Complete");
        });
      ...
      axios
        .post(
          `${DefaultUrl}/api/Joined-InvestmentBonds/Add-Joined-Investment-Bonds`,
          InvestmentBondsDetails
        )
        .then((res) =>
          console.log("Joined Investment Bonds Added Successfully!")
        );
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Joined-InvestmentBonds`).then((res) => {
        console.log("Joined got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let InvestmentProperties_onSubmit = (values) => {
    ...
    let InvestmentPropertiesDetails = {
      ...
      InvestmentPropertiesJointOwnership:
        values.InvestmentPropertiesJointOwnership,
      ...
      InvestmentPropertiesJointBorrowing:
        values.InvestmentPropertiesJointBorrowing,
    ...
    if (InvestmentPropertiesEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Joined-InvestmentProperties/Update-Client-Investment-Properties/${InvestmentPropertiesDetails.Email}/${values.id}`,
      ...
      axios
        .post(
          `${DefaultUrl}/api/Joined-InvestmentProperties/Add-Joined-Investment-Properties`,
          InvestmentPropertiesDetails
        )
        .then((res) =>
          console.log("Joined Investment Properties Added Successfully!")
        );
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Joined-InvestmentProperties`).then((res) => {
        console.log("Joined got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let Others_onSubmit = (values) => {
    ...
    if (OthersEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Joined-Others/Update-Joined-Others/${OthersDetails.Email}`,
          OthersDetails
        )
        .then((res) => {
          //Popper Massage
          console.log("Joined Other Updated Complete");
        });
    } else {
      setOthersEdit(true);
      axios
        .post(`${DefaultUrl}/api/Joined-Others/Add-Joined-Others`, OthersDetails)
        .then((res) =>
          console.log("Joined Other Investments Added Successfully!")
        );
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Joined-Others`).then((res) => {
        console.log("Joined got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let InvestmentModal_onSubmit = (values) => {
    ...
    axios
      .post(
        `${DefaultUrl}/api/Joined-Inner-InvestmentProperties/Add-Joined-Inner-Investment-Properties`,
        InvestmentPropertiesDetails
      )
      .then((res) =>
        console.log("Joined Investment Inner Modala data Added Successfully!")
      );
    console.log(InvestmentPropertiesDetails);
  };
  ...
  let onSubmit = (values) => {
    ...
    axios
      .post(`${DefaultUrl}/api/Joined-Investment/Add-Joined-Investment`, InvestmentDetails)
      .then((res) => console.log("Joined Investment Added Successfully!"));
  ...
  let TeamDepositDeleteHandler1 = (e) => {
    ...
    axios
      .patch(`${DefaultUrl}/api/Joined-TermDeposit/Update-Joined-TermDeposit/${email}`, data)
      .then((res) => {
        //Popper Massage
        console.log("Joined Bank Updated Complete");
      });
  ...
  let AustralianDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Joined-Australian-Market-Share/Delete-Joined-Australian-Market-Share/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
        console.log("Joined Australian Share Market Remove");
      });
  ...
  let AustralianLoanDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Joined-Australian-Share-Portfolio/Delete-Joined-Australian-Share-Portfolio/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
        console.log("Joined Australian Share Market Remove");
  ...
  let ManagedFundsDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Joined-ManagedFunds/Delete-Joined-ManagedFunds/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
        console.log("Joined Australian Share Market Remove");
  ...
  let ManagedFundsLoanDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Joined-ManagedFunds-Portfolio/Delete-Joined-ManagedFunds-Portfolio/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
        console.log("Joined Australian Share Market Remove");
  ...
  let InvestmentBondsDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Joined-InvestmentBonds/Delete-Joined-Investment-Bonds/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
        console.log("Joined Australian Share Market Remove");
  ...
  let InvestmentPropertiesDeleteHandler = (elem) => {
    ...
    axios
      ...
      .then((res) => {
        //Popper Massage
        console.log("Client Australian Share Market Remove");
      });
  ...
  let OtherDeleteHandler = (e) => {
    ...
    axios
      .patch(`${DefaultUrl}/api/Joined-Others/Update-Joined-Others/${data.Email}`, data)
      .then((res) => {
        //Popper Massage
            ...
            {({ values, handleChange , setFieldValue }) => (
              <Form>
                ...
                {CRObject.TermDepositsIssuesradio == "Yes" && (
                  <BankComponent api={`${DefaultUrl}/api/Joined-BankAccounts`} btnName={"JoinedProfessionalAdvisors"}
                ...
                {CRObject.TermDepositsIssuesradio == "Yes" && (
                  <TermComp api={`${DefaultUrl}/api/Joined-TermDeposit`} btnName={"JoinedTermDepositOpt"}
                  YesNObtn={values.TermDepositRadio} change={(data) => { setFieldValue("JoinedTermDepositRadio", data) }}  />
                )}
                {/* Term Deposit Details */}
                          ...
                          <div className="form-check form-switch m-0 p-0 ">
                            <div className="radiobutton">
                              <input
                                ...
                                id="JointAustralianShareMarketOpt1"
                                value="Yes"
                                onClick={() =>
                              ...
                              />
                              <label
                                htmlFor="JointAustralianShareMarketOpt1"
                                className="label1"
                              >
                                <span>YES</span>
                              </label>
                              <input
                                type="radio"
                                name="AustralianShareMarketRadio"
                                id="JointAustralianShareMarketOpt2"
                                value="No"
                                onClick={() =>
                              ...
                              />
                              <label
                                htmlFor="JointAustralianShareMarketOpt2"
                                className="label2"
                              >
                                <span>NO</span>
                              </label>
                            ...
                            <div className="form-check form-switch m-0 p-0 ">
                              <div className="radiobutton">
                                <input
                                  ...
                                  id="JointAustralianSharePortfolioOpt1"
                                  value="Yes"
                                  onClick={() =>
                                ...
                                />
                                <label
                                  htmlFor="JointAustralianSharePortfolioOpt1"
                                  className="label1"
                                >
                                  <span>YES</span>
                                </label>
                                <input
                                  type="radio"
                                  name="AustralianSharePortfolioRadio"
                                  id="JointAustralianSharePortfolioOpt2"
                                  value="No"
                                  onClick={() =>
                                ...
                                />
                                <label
                                  htmlFor="JointAustralianSharePortfolioOpt2"
                                  className="label2"
                                >
                                  <span>NO</span>
                                </label>
                            ...
                            <div className="form-check form-switch m-0 p-0 ">
                              <div className="radiobutton">
                                <input
                                  ...
                                  id="JointManagedFundsPortfolioOpt1"
                                  value="Yes"
                                  onClick={() =>
                                ...
                                />
                                <label
                                  htmlFor="JointManagedFundsPortfolioOpt1"
                                  className="label1"
                                >
                                  <span>YES</span>
                                </label>
                                <input
                                  type="radio"
                                  name="ManagedFundsPortfolioRadio"
                                  id="JointManagedFundsPortfolioOpt2"
                                  value="No"
                                  onClick={() =>
                                ...
                                />
                                <label
                                  htmlFor="JointManagedFundsPortfolioOpt2"
                                  className="label2"
                                >
                                  <span>NO</span>
                                </label>
                          ...
                          <Form>
                            <Modal.Body>
                              ...
                              <div className=" ">
                                ...
                                <div className="row">
                                  <div className="col-4 mb-3">
                                  <label htmlFor="ManagedFundsPortfolioLoanType"
                                  className="form-label" > Type of Loan </label>
                                  </div>
                                  <div className="col-4 mb-3">
                                  <Field
                                  as="select"
                        ...
                        <div className="mb-3">
                          ...
                          <div className="form-check form-switch m-0 p-0 ">
                            <div className="radiobutton">
                              ...
                              />
                              <label
                                htmlFor="JointInvestmentBondsOpt1"
                                className="label1"
                              >
                                <span>YES</span>
                              </label>
                              ...
                              />
                              <label
                                htmlFor="JointInvestmentBondsOpt2"
                                className="label2"
                              >
                                <span>NO</span>
                              </label>
                          ...
                          <Modal.Body>
                            ...
                            <div className=" ">
                              ...
                              <div className="row">
                                <div className="col-4 mb-3">
                                  <label
                                    htmlFor="InvestmentBondsPlatformName"
                                    className="form-label"
                                  >
                                    Platform Name
                                  </label>
                          ...
                          <div className="form-check form-switch m-0 p-0 ">
                            <div className="radiobutton">
                              <input
                                ...
                                id="JointInvestmentPropertiesOpt1"
                                value="Yes"
                                onClick={() =>
                              ...
                              />
                              <label
                                htmlFor="JointInvestmentPropertiesOpt1"
                                className="label1"
                              >
                                <span>YES</span>
                              </label>
                              <input
                                type="radio"
                                name="InvestmentPropertiesRadio"
                                id="JointInvestmentPropertiesOpt2"
                                value="No"
                                onClick={() =>
                              ...
                              />
                              <label
                                htmlFor="JointInvestmentPropertiesOpt2"
                                className="label2"
                              >
                                <span>NO</span>
                              </label>
                                  ...
                                  <div className="col-4 mb-3">
                                    <div className="radiobutton">
                                      <input
                                        ...
                                        value="Yes"
                                        onClick={() =>
                                          InvestmentProperties2Handler("Yes")
                                        }
                                        onChange={handleChange}
                                        checked={
                      ...
                      <div className="mb-3">
                        ...
                        <div className="form-check form-switch m-0 p-0 ">
                          <div className="radiobutton">
                            ...
                            />
                            <label htmlFor="JointOthersOpt1" className="label1">
                              <span>YES</span>
                            </label>
                            <input
                              type="radio"
                            ...
                            />
                            <label htmlFor="JointOthersOpt2" className="label2">
                              <span>NO</span>
                            </label>
                          </div>
                        </div>
                                    ...
                                    <Field
                                      ...
                                      value={
                                        values.OtherIncomePAType == ""
                                          ? 0
                                          : values.OtherIncomePAType == "dollor"
                                          ? parseFloat(values.OtherIncomePA) ||
                                            0
                                          : parseFloat(
                                              (
                                                ((parseFloat(
                                    ...
                                    <Field
                                      ...
                                      value={
                                        values.OtherIncomePAType2 == ""
                                          ...
                                          : values.OtherIncomePAType2 ==
                                            "dollor"
                                          ? parseFloat(values.OtherIncomePA2) ||
                                            0
                                          : parseFloat(
                                              (
                                                ((parseFloat(
...
export default JointInvestment;
