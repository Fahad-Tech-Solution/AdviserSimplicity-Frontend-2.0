...
function ClientInvestment(props) {
  ...
  let AustralianShareMarket_onSubmit = (values) => {
    ...
    if (AustralianShareMarketEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Client-Australian-Market-Share/Update-Client-Australian-Market-Share/${AustralianShareMarketDetails.Email}/${values.id}`,
      ...
      axios
        .post(
          `${DefaultUrl}/api/Client-Australian-Market-Share/Add-Client-Australian-Market-Share`,
          AustralianShareMarketDetails
        )
        .then((res) =>
          console.log("Australian Share Market Added Successfully!")
        );
      console.log(AustralianShareMarketDetails);
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Client-Australian-Market-Share`).then((res) => {
        console.log("got it");
  ...
  let AustralianSharePortfolio_onSubmit = (values) => {
    ...
    if (AustralianSharePortfolioEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Client-Australian-Share-Portfolio/Update-Client-Australian-Share-Portfolio/${AustralianSharePortfolioDetails.Email}/${values.id}`,
      ...
      axios
        .post(
          `${DefaultUrl}/api/Client-Australian-Share-Portfolio/Add-Client-Australian-Share-Portfolio`,
          AustralianSharePortfolioDetails
        )
        .then((res) =>
    ...
    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Client-Australian-Share-Portfolio`).then((res) => {
        console.log("got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let ManagedFunds_onSubmit = (values) => {
    ...
    if (ManagedFundsEdit) {
      ...
      axios
        .patch(
          `${DefaultUrl}/api/Client-ManagedFunds/Update-Client-ManagedFunds/${ManagedFundsDetails.Email}/${values.id}`,
          ManagedFundsDetails
        )
        .then((res) => {
          //Popper Massage
      ...
      axios
        .post(
          `${DefaultUrl}/api/Client-ManagedFunds/Add-Client-ManagedFunds`,
          ManagedFundsDetails
        )
    ...
    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Client-ManagedFunds`).then((res) => {
        console.log("got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let ManagedFundsPortfolio_onSubmit = (values) => {
    ...
    if (ManagedFundsLoanEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Client-ManagedFunds-Portfolio/Update-Client-ManagedFunds-Portfolio/${ManagedFundsPortfolioDetails.Email}/${values.id}`,
      ...
      axios
        .post(
          `${DefaultUrl}/api/Client-ManagedFunds-Portfolio/Add-Client-ManagedFunds-Portfolio`,
          ManagedFundsPortfolioDetails
        )
        .then((res) =>
          console.log("Managed Funds Portfolio Added Successfully!")
        );
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Client-ManagedFunds-Portfolio`).then((res) => {
        console.log("got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let InvestmentBonds_onSubmit = (values) => {
    ...
    if (InvestmentBondsEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Client-InvestmentBonds/Update-Client-Investment-Bonds/${InvestmentBondsDetails.Email}/${values.id}`,
      ...
      axios
        .post(
          `${DefaultUrl}/api/Client-InvestmentBonds/Add-Client-Investment-Bonds`,
          InvestmentBondsDetails
        )
    ...
    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Client-InvestmentBonds`).then((res) => {
        console.log("got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let Others_onSubmit = (values) => {
    ...
    if (OthersEdit) {
      axios
        .patch(
          `${DefaultUrl}/api/Client-Others/Update-Client-Others/${OthersDetails.Email}`,
          OthersDetails
        )
        .then((res) => {
          //Popper Massage
      ...
      setOthersEdit(true);
      axios
        .post(`${DefaultUrl}/api/Client-Others/Add-Client-Others`, OthersDetails)
        .then((res) => console.log("Other Investments Added Successfully!"));
    }

    setTimeout(() => {
      axios.get(`${DefaultUrl}/api/Client-Others`).then((res) => {
        console.log("got it");
        let clientObj = res.data;
        let clientFilterObj = clientObj.filter(
  ...
  let onSubmit = (values) => {
    ...
    console.log("Testing investment Client Child", InvestmentDetails);

    axios
      .post(`${DefaultUrl}/api/Client-Investment/Add-Client-Investment`, InvestmentDetails)
  ...
  let AustralianDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Client-Australian-Market-Share/Delete-Client-Australian-Market-Share/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
  ...
  let AustralianLoanDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Client-Australian-Share-Portfolio/Delete-Client-Australian-Share-Portfolio/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
        console.log("Australian Share Market Remove");
  ...
  let ManagedFundsDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Client-ManagedFunds/Delete-Client-ManagedFunds/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
        console.log("Australian Share Market Remove");
  ...
  let ManagedFundsLoanDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Client-ManagedFunds-Portfolio/Delete-Client-ManagedFunds-Portfolio/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
        console.log("Australian Share Market Remove");
  ...
  let InvestmentBondsDeleteHandler = (elem) => {
    ...
    axios
      .delete(
        `${DefaultUrl}/api/Client-InvestmentBonds/Delete-Client-Investment-Bonds/${email}/${id}`
      )
      .then((res) => {
        //Popper Massage
        console.log("Australian Share Market Remove");
  ...
  let OtherDeleteHandler = (e) => {
    ...
    axios
      .patch(`${DefaultUrl}/api/Client-Others/Update-Client-Others/${data.Email}`, data)
      .then((res) => {
        //Popper Massage
        console.log("Bank Updated Complete");
      });
        ...
        <div className="col-md-12">
          ...
          >
            {({ values, handleChange, setFieldValue }) => (
              <Form>
                {props.ClientDrill === true && onSubmit(values)}

                {/* Bank Account Details */}
                {CRObject.TermDepositsIssuesradio == "Yes" && (
                  <BankComponent api={`${DefaultUrl}/api/Client-BankAccounts`} btnName={"ProfessionalAdvisors"}
                ...
                {CRObject.TermDepositsIssuesradio == "Yes" && (
                  <TermComp api={`${DefaultUrl}/api/Client-TermDeposit`} btnName={"TermDepositOpt"}
                    YesNObtn={values.TermDepositRadio} change={(data) => { setFieldValue("TermDepositRadio", data) }} />
                )}
                {/* Term Deposit Details */}
                        ...
                        <div className="mb-3">
                          ...
                          <div className="form-check form-switch m-0 p-0 ">
                            <div className="radiobutton">
                              ...
                              />
                              <label
                                htmlFor="AustralianShareMarketOpt1"
                                className="label1"
                              >
                                <span>YES</span>
                              </label>
                              ...
                              />
                              <label
                                htmlFor="AustralianShareMarketOpt2"
                                className="label2"
                              >
                                <span>NO</span>
                              </label>
                            ...
                            <div className="form-check form-switch m-0 p-0 ">
                              <div className="radiobutton">
                                <input
                                  ...
                                  id="AustralianSharePortfolioOpt1"
                                  value="Yes"
                                  onClick={() =>
                                ...
                                />
                                <label
                                  htmlFor="AustralianSharePortfolioOpt1"
                                  className="label1"
                                >
                                  <span>YES</span>
                                </label>
                                <input
                                  type="radio"
                                  name="AustralianSharePortfolioRadio"
                                  id="AustralianSharePortfolioOpt2"
                                  value="No"
                                  onClick={() =>
                                ...
                                />
                                <label
                                  htmlFor="AustralianSharePortfolioOpt2"
                                  className="label2"
                                >
                                  <span>NO</span>
                                </label>
                          ...
                          <div className="mb-3">
                            ...
                            <div className="form-check form-switch m-0 p-0 ">
                              <div className="radiobutton">
                                ...
                                />
                                <label
                                  htmlFor="ManagedFundsPortfolioOpt1"
                                  className="label1"
                                >
                                  <span>YES</span>
                                </label>
                                ...
                                />
                                <label
                                  htmlFor="ManagedFundsPortfolioOpt2"
                                  className="label2"
                                >
                                  <span>NO</span>
                                </label>
