...
class PartnerSMSF {
  section() {
    ...
    cy.get("#clientcf_SMSFAccumulationDetails").should("have.value", "$265");
    cy.get("#partnercf_SMSFAccumulationDetails").should("have.value", "$265");
    ...
    //   cy.get("#nominatedRolloverAmountValue")
    //     .clear()
    //     .type("66")
    ...
    // cy.get("#clientcf_SMSFPensionAccountDetails").should("have.value", "$24");
    // cy.get("#partnercf_SMSFPensionAccountDetails").should("have.value", "$24");
    ...
    cy.contains("ATO LEVY");
    cy.get(":nth-child(2) > :nth-child(6) > #atoLevy")
      .clear()
      .type("23")
      .should("have.value", "$23");

    cy.contains("Adviser Service Fees");
    cy.get(":nth-child(2) > :nth-child(7) > #adviserFees")
      .clear()
      .type("23")
      .should("have.value", "$23");
    ...
    cy.get("#clientcf_SMSF").should("have.value", "$24");
    cy.get("#partnercf_SMSF").should("have.value", "$24");
    ...
    cy.get(":nth-child(7) > .modal-dialog > .modal-content > .modal-header")
      .first()
      .within(() => {
        cy.contains("Loan Balance");
        //cy.get('[style="display: block;"] > .modal-dialog > .modal-content > .modal-header > .btn-close').should('be.visible')
    ...
    cy.get('[placeholder="Loan Balance"]');
  }
}
