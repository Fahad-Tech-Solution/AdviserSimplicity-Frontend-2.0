...
//     //Partner Section Australian Shares Inner Footer
...
//     cy.get(':nth-child(2) > :nth-child(9) > #investmentFees').clear().type("2.50%");
...
//   cy.get('#partnercf_platformInvestment').should("have.value", "$24");
...
//   //Partner Section  Other Investments Returns Inner Card
//   cy.get(
//     '[style="display: block;"] > .modal-dialog > .modal-content > .modal-header'
//   ).within(() => {
//     cy.contains("Input Override");
...
//   //Partner Section Other Investments Inner Footer

//   cy.contains("Close").should("be.visible");
//   cy.contains("Submit").should("be.visible").click();

//   cy.get('#clientcf_otherInvestments').should("have.value", "$24");
//   cy.get('#partnercf_otherInvestments').should("have.value", "$24");
...
//       cy.contains("Surplus/Deficit");
//       cy.get(":nth-child(9) > .form-select").select("Aiden Smith");
...
//       cy.contains("State")
//       cy.get(':nth-child(6) > .form-select').select("ACT").should('have.value', 'ACT');
...
//       cy.get(":nth-child(13) > .form-select").should("have.value", "No");

//       cy.contains("Convert into PPR in year");
//       cy.get(":nth-child(13) > .form-select").should("have.value", "No");

// cy.contains("Estimated Future Sellling Cost (%)")
//       cy.get(':nth-child(14) > .form-select').select("2.50%")

//       cy.get(":nth-child(8) > .d-flex > .btn").click();
//     });
...
//     cy.get(":nth-child(10) > .form-check > .radioButton2")
//       .contains("Yes")
//       .click();
//     cy.get("#button-addon2").click();
...
//       cy.get(':nth-child(4) > .form-select').select("10").should('have.value', '10');
...
//       cy.get(':nth-child(8) > .form-check > .radioButton2').contains("Yes").click();
...
//     // cy.get("#partnercf_investmentBonds").should("have.value", "$24");
  ...
  //     cy.get(':nth-child(2) > :nth-child(2) > #originalInvestmentAmount')
  //       .clear()
  //       .type("99")
  //       .should("have.value", "$99");

  //     cy.contains("Source of Funds").should("be.visible");
  //     cy.get(':nth-child(2) > :nth-child(3) > .form-select').select("Super");

  //     cy.contains("Annuity Type").should("be.visible");
  //     cy.get(':nth-child(2) > :nth-child(4) > .form-select').select("Life-Time");
  ...
  //     cy.contains("Include From Year");
  //     cy.get(':nth-child(2) > :nth-child(7) > .form-select').select(17);

  //     cy.contains("Term");
  //     cy.get(':nth-child(2) > :nth-child(8) > .form-select').select("21");

  //     cy.contains("Years Until Maturity");
  //     cy.get(':nth-child(2) > :nth-child(9) > .form-select').select("10");

  //     cy.contains("Annual Inflation Rate");
  //     cy.get(':nth-child(2) > :nth-child(10) > .form-select').select("2.50%");

  //     cy.contains("Annual Payment");
  //     cy.get(':nth-child(2) > :nth-child(11) > #annualPayment').clear().type("99").should("have.value", "$99");
  ...
  //       //Deductible Amount
  //       cy.contains("Deductible Amount");
  //       cy.get('tbody > :nth-child(2) > :nth-child(12)').within(() => {
  //         cy.contains("Yes").click();
  //         cy.get("#button-addon2").click();
  //       });
  ...
  //   cy.get('#partnercf_annuities').should('have.value', '$99');
...
//   cy.contains("Risk Profile").should("be.visible");
//   cy.get(':nth-child(2) > :nth-child(4) > .form-select').select("Growth");

//   cy.contains("Investment Fees %").should("be.visible");
//   cy.get(':nth-child(2) > :nth-child(6) > #investmentFees').clear().type("2");

//   cy.contains("Adviser Service Fee ($)");
//   cy.get(':nth-child(2) > :nth-child(7) > #adviserServiceFee')
//     .clear()
//     .type("99")
//     .should("have.value", "$99");
...
// cy.contains("Investment Returns");
// cy.get(':nth-child(2) > :nth-child(5) > .input-group > .form-select').select("Input Override")
...
// cy.contains("Pension Payments");
// cy.get(':nth-child(2) > :nth-child(8) > .input-group').within(() => {
//   cy.get('button[type="button"]').click();
// });
...
// cy.get('tbody > :nth-child(2) > :nth-child(9)').within(() => {
//   cy.contains("Yes").click();
//   cy.get("#button-addon2").first().click();
// });
...
// cy.get('tbody > :nth-child(2) > :nth-child(10)').within(() => {
//   cy.contains("Yes").click();
//   cy.get("#button-addon2").first().click();
// });
...
// cy.get('#partnercf_accountBasedPension').should('have.value', '$99');
 ...
 //Super Fund
    ...
    cy.contains("Non Concessional Contributions").click()
    cy.get('tbody > tr > :nth-child(10)').within(() => {
      cy.contains("Yes").click();
      cy.get("#button-addon2").click();
    });
    ...
    cy.get(".table").within(() => {
      cy.contains("Owner");
      cy.contains("Emma Taylor");
      cy.contains("Risk Profile")
      cy.get(':nth-child(2) > :nth-child(3) > .form-select').select("Growth");
      ...
      cy.contains("Investment Fees %");
      cy.get(':nth-child(2) > :nth-child(5) > #investmentFees')
        .clear()
        .type("99")


        cy.contains("Adviser Service Fee ($)")
        cy.get(':nth-child(2) > :nth-child(6) > #adviserServiceFee').clear().type("99").should("have.value", "$99");
    ...
    cy.get(".col-md-12 > .row > .mt-4").within(() => {
      ...
      cy.contains("Current Balance");
      cy.get("#currentBalance").clear().type("4,536").should("have.value", "$4,536");

      cy.contains("Tax-Free Component");
      cy.get("#taxFreeComponent").clear().type("21").should("have.value", "$21");
    ...
    cy.get(".col-md-12 > .row > .mt-4").within(() => {
      ...
      cy.contains("Insurance Premiums");
      cy.get("#insurancePremiums").clear().type("85").should("have.value", "$85");
    ...
    cy.contains("Rollover Funds");
    cy.get('tbody > :nth-child(2) > :nth-child(8)').within(() => {
      cy.contains("Yes").click();
      cy.get("#button-addon2").click();
    });
    ...
    cy.get(".modal-footer .modalBtn").filter(":visible").first().click();
      ...
      cy.get('[style="display: block;"] > .modal-dialog > .modal-content > .modal-footer > .bgColor').first().click();

    //	Withdrawals

    cy.contains("Withdrawals");

    cy.get('tbody > :nth-child(2) > :nth-child(11)').within(() => {
      cy.contains("Yes").click();
      cy.get("#button-addon2").first().click();
    });
