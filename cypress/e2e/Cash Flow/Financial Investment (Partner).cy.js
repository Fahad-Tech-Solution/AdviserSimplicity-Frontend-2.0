...
class PartnerFinancialInvestments {
  section() {
    ...
    cy.get(":nth-child(2) > :nth-child(9) > .form-select").select(
      "Emma Taylor"
    );
    ...
    //Partner Section Cash Inner Footer
    ...
    cy.get(".table").within(() => {
      ...
      cy.contains("Annual Payment");
      cy.get(":nth-child(2) > :nth-child(11) > #annualPayment")
        .clear()
        .type("99")
        .should("have.value", "$99");
    ...
    cy.get(".table").within(() => {
      ...
      cy.contains("Investment Fees %").should("be.visible");
      cy.get(":nth-child(2) > :nth-child(6) > #investmentFees")
        .clear()
        .type("2");
    ...
    cy.contains("Investment Returns");
    cy.get(
      ":nth-child(2) > :nth-child(5) > .input-group > .form-select"
    ).select("Input Override");
    ...
    cy.get(".table").within(() => {
      ...
      cy.contains("Adviser Service Fee ($)");
      cy.get(":nth-child(2) > :nth-child(6) > #adviserServiceFee")
        .clear()
        .type("99")
        .should("have.value", "$99");
    ...
    cy.get("#partnercf_superFund").should("have.value", "$99");
    ...
    cy.get(".table").within(() => {
      ...
      cy.contains("Reinvest Up Until");
      cy.get(":nth-child(6) > .form-select").select("10");
    ...
    cy.get(".table").within(() => {
      ...
      cy.get(":nth-child(2) > :nth-child(6) > .form-select").select("21");

      cy.get(":nth-child(2) > :nth-child(8) > .form-select").select("Other");

      cy.get(":nth-child(2) > :nth-child(9) > .form-select").select("28");
