...
class PartnerFinancialInvestments {
  section() {
    ...
    //    cy.contains("Initial Interest Rate (p.a.)");
    //    cy.get(':nth-child(2) > :nth-child(5) > #initialInterestRate').clear().type("20.00%");

    //    cy.contains("Deductible interest");
    //    cy.get(':nth-child(2) > :nth-child(6) > #deductibleInterest').clear().type("20.00%");
    ...
    //   cy.get(':nth-child(2) > :nth-child(2) > #currentBalance').clear().type("24").should("have.value", "$24");
    ...
    //   cy.get(':nth-child(2) > :nth-child(5) > .form-check > .radioButton2').contains("Yes").click();

    //   cy.get(':nth-child(2) > :nth-child(7) > .form-select').select("Cash");

    //   cy.get(':nth-child(2) > :nth-child(6) > .form-check > .radioButton2').contains("Yes").click();
    ...
    //     cy.get(':nth-child(2) > :nth-child(3) > #costBase').clear().type("77").should("have.value", "$77");
    ...
    //   cy.get(':nth-child(2) > :nth-child(5) > #earningsRate').clear().type("23").should("have.value", "23");
