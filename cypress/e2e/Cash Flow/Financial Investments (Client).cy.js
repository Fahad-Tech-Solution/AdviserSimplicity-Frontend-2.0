...
class ClientFinancialInvestments {
  section() {
    ...
    //Australian Shares footer section
    ...
    cy.get(".table").within(() => {
      ...
      cy.contains("Investment Returns");
      cy.get(":nth-child(3) > .form-select").select("System");

      cy.contains("Income Yield").click();
      cy.get("#incomeYield");
    ...
    cy.get(".table").within(() => {
      ...
      cy.contains("Investment Returns").should("be.visible");
      cy.get(":nth-child(4) > .form-select").select("System");
