class PersonalAssetsAndDebt {
  section() {
    ...
    //   cy.get("#repaymentsAmount") .clear().type("543").should("have.value", "$543");
    ...
    //   cy.get(":nth-child(6) > #annualRepayments") .clear()
    //     .type("543")
...
//       cy.contains('Car')
//       cy.get('img')
//       cy.get('label.mb-0.bg-secondary.rounded-circle.text-light.py-1.px-2.curser-pointer')
//       .click();
...
// cy.get('#modelOfCar').clear()
//     .type("77")
//     .blur()
//     .should("have.value", "77");

// cy.get('#currentValue').clear()
//     .type("77")
//     .blur()
//     .should("have.value", "$77");

//     cy.get('.modal-footer > .bgColor').click()
