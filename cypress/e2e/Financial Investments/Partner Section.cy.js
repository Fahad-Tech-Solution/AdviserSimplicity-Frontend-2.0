class FinancialInvestmentsPartnerSection {
  section() {
    ...
    cy.get("#clientCurrentBalance").should("have.value", "$23");
    ...
    cy.get("#partnerCurrentBalance").should("have.value", "$23");
    ...
    cy.get('[style="display: block;"] > .modal-dialog > .modal-content').within(
      () => {
        cy.contains("Emma Taylor_Annuities Detail");
        cy.contains("How many Annuities does Emma Taylor have :");
        cy.get("#NumberOfMap").clear().type(1);
      }
    );
    //Inner Table
    ...
    cy.contains("Emma Taylor_Annual Pension Payment");
    ...
    cy.get(":nth-child(7) > .modal-dialog > .modal-content").within(() => {
      cy.contains("Emma Taylor_Beneficiaries");

      cy.contains("How many beneficiaries do Emma Taylor have :");
      ...
      cy.contains("Beneficiary Name");
      cy.get("#beneficiaryName0");

      cy.contains("Relationship Status");
      cy.get("#relationshipStatus0").should("have.value", "N/A");
    ...
    cy.get("#partnerCurrentBalance").should("have.value", "$5,000");
    //Footer
    cy.get("#clientCurrentBalance").should("not.have.value", "");
    cy.contains("Close");
    cy.get(".modal-footer > .bgColor")
    ...
    cy.get("#clientannuitiesIssues").should("not.have.value", "");
    cy.get("#partnerannuitiesIssues").should("not.have.value", "");
    ...
    cy.get(".table").within(() => {
      ...
      cy.contains("Loan Balance");
      cy.get(":nth-child(2) > :nth-child(3) > #loanBalance")
        .clear()
        .type("$983")
        .blur();
      ...
      cy.contains("Repayments Amount");
      cy.get(":nth-child(2) > :nth-child(5) > #repaymentsAmount")
        .clear()
        .type("$567")
        .blur();
      ...
      cy.contains("Annual Repayments");
      cy.get(":nth-child(2) > :nth-child(7) > .mb-3 > #annualRepayments")
        .clear()
        .type("22")
        .blur();
      cy.get(":nth-child(2) > :nth-child(7) > .mb-3 > #serviceFeeType").select(
        "Weekly"
      );

      cy.contains("Interest Rate (p.a)");
      cy.get(":nth-child(2) > :nth-child(8) > #interestRate")
        .clear()
        .type("52")
        .blur();
      ...
      cy.contains("Deductible Loan Amount");
      cy.get(":nth-child(2) > :nth-child(11) > #deductibleLoanAmount")
        .clear()
        .type("33.00%")
        .blur();
    });
    ...
    cy.get("#partnermanagedFundsLOC").should("not.have.value", "");
    ...
    cy.get(".table").within(() => {
      ...
      cy.contains("Lender");
      cy.get(':nth-child(2) > [style="width: 15rem;"] > .form-select').select(
        "Testing"
      );
      ...
      cy.contains("Monthly Contribution");
      cy.get(":nth-child(2) > :nth-child(4) > #monthlyContribution")
        .clear()
        .type("$85")
        .blur();

      cy.contains("Annual Loan Contributions");
      cy.get(":nth-child(2) > :nth-child(5) > #annualLoan").should(
        "have.value",
        "$1,020"
      );

      cy.contains("Interest Rate (p.a)");
      cy.get(":nth-child(2) > :nth-child(6) > #interestRate")
        .clear()
        .type("202")
        .blur();

      cy.contains("Loan Term");
      cy.get(":nth-child(2) > :nth-child(7) > .form-select").select("Year 19");

      cy.contains("Loan Term Remaining");
      cy.get(":nth-child(2) > :nth-child(8) > .form-select").select("Year 22");

      cy.contains("Deductible Loan Amount");
      cy.get(":nth-child(2) > :nth-child(9) > #deductibleLoanAmount")
        .clear()
        .type("202")
        .blur();
    });
    ...
    cy.get("#partnermanagedFundsMarginLoan").should("not.have.value", "");
  }
}
