class FinancialInvestments {
  section() {
   ...
   // Super Funds
    ...
    cy.get('[style="display: block;"] > .modal-dialog > .modal-content').within(
      () => {
        cy.contains("Aiden Smith_Super Funds Detail");
        cy.contains("How many Super Funds does Aiden Smith have :");
        cy.get("#NumberOfMap").clear().type(1);
      }
    );
    //Inner Table
    ...
    cy.contains("Aiden Smith_Balance & Benefit Details");
    ...
    cy.contains("Aiden Smith_Insurances");
    ...
    cy.get(":nth-child(7) > .modal-dialog > .modal-content").within(() => {
      cy.contains("Aiden Smith_Contributions");

      cy.contains("How many Contributions do Aiden Smith have ?");
    ...
    cy.get(":nth-child(7) > .modal-dialog > .modal-content").within(() => {
      cy.get("#NumberOfMap").clear();
    });
    cy.get(":nth-child(7) > .modal-dialog > .modal-content")
      .contains("Submit")
      .click();
    cy.get(":nth-child(8) > .d-flex > #button-addon2").click();
    ...
    cy.get('[style="display: block;"] > .modal-dialog > .modal-content').within(
      () => {
        cy.contains("Aiden Smith_Account Based Pension Detail");
        cy.contains("How many Account Based Pension does Aiden Smith have :");
        cy.get("#NumberOfMap").clear().type(1);
      }
    );
    //Inner Table
    ...
    cy.contains("How many Underlying Investments does Aiden Smith have :");
    cy.get(':nth-child(7) > .modal-dialog > .modal-content > .modal-body > form > :nth-child(1) > .col-md-12 > .row > .d-flex > div > #NumberOfMap')
      .clear()
      .type(1);
    ...
    cy.get(":nth-child(7) > .modal-dialog > .modal-content").within(() => {
      ...
      cy.get("#NumberOfMap").clear() // Types the number 123 into the input field
