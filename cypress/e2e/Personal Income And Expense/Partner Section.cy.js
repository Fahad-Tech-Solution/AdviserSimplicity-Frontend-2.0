class PersonalIncomeAndExpensePartnerSection {
  section() {
    ...
    //   cy.get(':nth-child(2) > :nth-child(2) > #occupation').clear().type("Occupation").should("be.visible");
    //   // Checking if 'Employment Status' is visible and clicking the dropdown

    //   cy.get(':nth-child(2) > :nth-child(3) > #employmentStatus').select("Full Time"); // Select "Full Time" option by text

    //   cy.get(':nth-child(2) > :nth-child(4) > #nameOfCompany').clear().type("Software Company");
    //   cy.contains("Start Date");
    //   cy.get(':nth-child(2) > :nth-child(5) > [style="min-width: 100px;"] > .react-datepicker-wrapper > .react-datepicker__input-container > #startDate').clear().type("06/11/2024").should("exist");
    //   cy.contains("Hours Worked");
    //   cy.get(':nth-child(2) > :nth-child(6) > #hoursWorked').clear().type("65").should("be.visible");
    //   cy.contains("Salary Package");
    ...
    // cy.contains("Salary Packaging");
    // cy.get(':nth-child(2) > :nth-child(8)')
    //   .contains("Yes")
    //   .click();
    ...
    // cy.contains("Leave entitlements");
    // cy.get(':nth-child(2) > :nth-child(9) > .d-flex > .form-check > .radioButton2 > .tableYesLabel > span').click();
    ...
    // cy.contains("Choice of Fund");
    // cy.get(':nth-child(2) > :nth-child(10) > .d-flex > .form-check > .radioButton2 > .tableYesLabel > span').click();
    ...
    // cy.get("#clientincomeFromOwnBusiness").should("not.have.value", "54");
    // cy.get('#partnerincomeFromOwnBusiness').should("not.have.value", "54");
    ...
    //    cy.get(':nth-child(2) > :nth-child(2) > #businessName').clear().type("Office").should("be.visible");

    //    cy.get(':nth-child(2) > :nth-child(3) > #ABN').clear().type("987").should("be.visible");

    //    cy.get(':nth-child(2) > :nth-child(4) > #businessAddress').clear().type("Onside").should("be.visible");

    //    cy.get(':nth-child(2) > :nth-child(5) > #netBusinessIncome').clear().type("9899").should("be.visible");

    //    cy.get(':nth-child(2) > :nth-child(6) > #goodWill').clear().type("7677").should("be.visible");
    ...
    // cy.get('#partnerincomeFromSoleTrader')
    ...
    //  cy.get(':nth-child(2) > :nth-child(5) > #totalNetPartnershipIncome').clear().type("9899").should("be.visible");

    //  cy.get(':nth-child(2) > :nth-child(6) > #shareOfPartnership').clear().type("20").should("be.visible");

    //  cy.get(':nth-child(2) > :nth-child(8) > #goodWill').clear().type("7677").should("be.visible");
