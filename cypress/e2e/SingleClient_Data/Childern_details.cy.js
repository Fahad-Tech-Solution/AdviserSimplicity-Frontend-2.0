class Childern_Details {
  ...
  cy.get('thead > tr > :nth-child(4)').should('have.text', 'Gender').wait(1000);
  cy.get('thead > tr > :nth-child(5)').should('have.text', 'Add in Relationship').wait(1000);
  cy.get('thead > tr > :nth-child(6)').should('have.text', 'Add in is Child Depenant').wait(1000);
